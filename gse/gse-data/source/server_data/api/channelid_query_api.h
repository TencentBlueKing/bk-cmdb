...
#ifndef _GSE_DATA_CHANNELID_QUERY_API_H_
#define _GSE_DATA_CHANNELID_QUERY_API_H_
...
public:
    ChannelIdQuery(const std::string &requestId);
...
const std::string ChannelIdQueryHandlerURI = "/dataroute/v1/query_route";
const std::string ChannelIdQueryHandlerURIV2 = "/api/v2/data/config/query_route";

class ChannelIdQueryAPIHandler : public gse::net::http::HTTPHandler
{

public:
    ChannelIdQueryAPIHandler(const std::string &version = "v2");
    virtual ~ChannelIdQueryAPIHandler();
...
private:
    ...
    const std::string m_metricsApiName = {"query_route"};
