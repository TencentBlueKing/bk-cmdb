...
#ifndef _GSE_DATA_PROXY_EXPORTER_GSEDATA_PACKAGE_EXTENSION_H_
#define _GSE_DATA_PROXY_EXPORTER_GSEDATA_PACKAGE_EXTENSION_H_
...
private:
    //DISALLOW_COPY_AND_ASSIGN(GSEDataPackageExtension);
