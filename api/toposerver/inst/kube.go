...
func (t *instanceClient) CreateNamespace(ctx context.Context, header http.Header, bizID int64,
	option *types2.NsCreateReq) (*types2.NsCreateRespData, errors.CCErrorCoder) {
...
func (t *instanceClient) ListNamespace(ctx context.Context, header http.Header, bizID int64, option *types2.NsQueryReq) (
...
func (t *instanceClient) CreateWorkload(ctx context.Context, header http.Header, bizID int64, kind types2.WorkloadType,
...
func (t *instanceClient) UpdateWorkload(ctx context.Context, header http.Header, bizID int64, kind types2.WorkloadType,
...
func (t *instanceClient) DeleteWorkload(ctx context.Context, header http.Header, bizID int64, kind types2.WorkloadType,
...
func (t *instanceClient) ListWorkload(ctx context.Context, header http.Header, bizID int64, kind types2.WorkloadType,
...
// ListPod list pod
func (t *instanceClient) ListPod(ctx context.Context, header http.Header, bizID int64, option *types2.PodQueryReq) (
	*metadata.InstDataInfo, errors.CCErrorCoder) {
...
func (t *instanceClient) ListContainer(ctx context.Context, header http.Header, bizID int64,
	option *types2.ContainerQueryReq) (*metadata.InstDataInfo, errors.CCErrorCoder) {
...
func (t *instanceClient) FindNodePathForHost(ctx context.Context, header http.Header, option *types2.HostPathReq) (
	*types2.HostPathData, errors.CCErrorCoder) {

	result := types2.HostPathResp{}
...
func (t *instanceClient) FindPodPath(ctx context.Context, header http.Header, bizID int64, option *types2.PodPathReq) (
	*types2.PodPathData, errors.CCErrorCoder) {

	result := types2.PodPathResp{}
