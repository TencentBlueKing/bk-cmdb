...
// 模型分组
export const B_C_MODEL_GROUP = 'xxxx'
export const B_U_MODEL_GROUP = 'xxxx'
export const B_D_MODEL_GROUP = 'xxxx'

// 模型
export const B_C_MODEL = 'xxxx'
export const B_U_MODEL = 'xxxx'
