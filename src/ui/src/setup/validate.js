...
const buildInVaidationRules = {
  ...
  reservedFieldId: {
    validate: value => !['id', 'create_time', 'last_time'].includes(value)
  },
  ipSearchMaxCloud: {
    validate: (value) => {
...
const dictionary = {
  zh_CN: {
    messages: {
      ...
      reservedFieldId: () => '"id"、"create_time"、"last_time" 为系统保留字段，不支持创建',
  ...
  en: {
    messages: {
      ...
      reservedFieldId: () => '"id", "create_time", "last_time" are system-reserved fields and cannot be created',
