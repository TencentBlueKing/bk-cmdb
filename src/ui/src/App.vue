...
<template>
  <div
    ...
    :bk-language="$i18n.locale"
    :class="{
      'no-breadcrumb': hideBreadcrumbs,
      'main-full-screen': mainFullScreen,
    }">
    <div v-if="showBrowserTips" class="browser-tips">
      ...
      <i
        class="tips-icon bk-icon icon-close-circle-shape"
        @click="showBrowserTips = false"></i>
    </div>
    <the-header></the-header>
    <router-view
      ref="topView"
      class="views-layout"
      :name="topView"></router-view>
