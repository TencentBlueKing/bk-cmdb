  ...
  <cmdb-sticky-layout class="form-layout">
                ...
                <li
                  ...
                  <div
                    ...
                    <span
                      ...
                      :class="{ required: isRequired(property) }">
                  ...
                  <div class="property-value clearfix">
                    <slot :name="property.bk_property_id">
                      <component
                        ...
                        v-bind="{
                          ...$attrs,
                          ...$tools.getValidateEvents(property),
                        }"
                      ...
                      <form-append
                        :type="type"
                        :property="property"
                        :render="renderAppend"></form-append>
                      <span
                        class="form-error"
    ...
    <div
      ...
      <slot name="form-options">
        ...
        <bk-button class="button-cancel" @click="handleCancel">{{
          $t('取消')
        }}</bk-button>
      </slot>
  ...
  methods: {
    ...
    checkEditable(property) {
      ...
      return (
        property.editable &&
        !property.bk_isapi &&
        !this.uneditableProperties.includes(property.bk_property_id)
      )
    },
    checkDisabled(property) {
      ...
      return (
        !property.editable ||
        property.isreadonly ||
        this.disabledProperties.includes(property.bk_property_id)
      )
    },
    isRequired(property) {
    ...
    getValidateRules(property) {
      ...
      if (
        ...
        [
          ...
          'bk_module_name',
          'bk_inst_name',
        ].includes(property.bk_property_id)
      ) {
    ...
    async handleSave() {
      ...
      const results = await Promise.all(validatePromise).finally(
