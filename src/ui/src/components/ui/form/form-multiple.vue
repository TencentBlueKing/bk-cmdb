...
<template>
  <cmdb-sticky-layout class="form-layout">
    <div v-if="hasAvaliableGroups" ref="formGroups" class="form-groups">
                ...
                <li
                  ...
                  <cmdb-auth
                    ...
                    <bk-checkbox
                      ...
                      slot-scope="{ disabled }"
                      class="property-name-checkbox"
                      :disabled="
                        disabled ||
                        $tableTypePropertyIds.includes(
                      ...
                      <span
                        v-bk-tooltips.top-start="{
                          content: $t('暂不支持'),
                          disabled: !$tableTypePropertyIds.includes(
                            property['bk_property_id']
                          ),
                        }"
                        ...
                        :class="{
                          required:
                            property['isrequired'] &&
                            editable[property.bk_property_id],
                        }">
                    ...
                    <i
                      ...
                      class="property-name-tooltips icon icon-cc-tips">
                    </i>
                  </cmdb-auth>
    ...
    groupedProperties() {
      return this.$groupedProperties.map(properties =>
        properties.filter(property => {
          ...
          const isAsst = ['singleasst', 'multiasst'].includes(
