...
<script>
  ...
  import CmdbLongchar from '@/components/ui/form/longchar.vue'
  ...
  export default defineComponent({
    ...
    props: {
      ...
      type: {
        type: String,
        default: 'singlechar',
        validator: val => ['singlechar', 'longchar', 'enum'].includes(val)
      },
      // 权限数据，仅使用在编辑按钮上
      auth: {
        type: Object,
