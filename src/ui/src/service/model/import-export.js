...
const exportService = objId =>
  http.download({
    url: `${window.API_HOST}object/object/${objId}/export`,
    data: {},
  })
 ...
 * @returns {Promise}
 */
export const batchImportFileAnalysis = ({ file, password }) => {
  ...
  return http
    .post(`${window.API_HOST}object/importmany/analysis`, importData, {
      globalError: false,
      transformData: false,
    })
    .then(res => {
 ...
 * @returns {Promise}
 */
export const batchImport = ({ import_object, import_asst }) =>
