...
const actions = {
  ...
  searchProcess(
    ...
    return $http.post(
      `proc/search/${rootGetters.supplierAccount}/${bizId}`,
      params,
      config
    )
  },
  ...
  getProcessDetail(
    ...
    return $http.get(
      `proc/${rootGetters.supplierAccount}/${bizId}/${processId}`
    )
  },
  ...
  getProcessBindModule(
    { commit, state, dispatch, rootGetters },
    { bizId, processId, config }
  ) {
    return $http.get(
      `proc/module/${rootGetters.supplierAccount}/${bizId}/${processId}`,
      config
    )
  },
  ...
  bindProcessModule(
    { commit, state, dispatch, rootGetters },
    { bizId, processId, moduleName, config }
  ) {
    return $http.put(
      `proc/module/${rootGetters.supplierAccount}/${bizId}/${processId}/${moduleName}`,
      {},
      config
    )
  },
