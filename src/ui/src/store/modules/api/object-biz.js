...
const getters = {
  ...
  currentBusiness: state =>
    state.authorizedBusiness.find(
      business => business.bk_biz_id === state.bizId
    ),
...
const actions = {
  ...
  createBusiness({ commit, state, dispatch, rootGetters }, { params, config }) {
    return $http.post(
      `${window.API_HOST}table/biz/${rootGetters.supplierAccount}`,
      params,
      config
    )
  },
  ...
  updateBusiness(
    ...
    return $http.put(
      `biz/${rootGetters.supplierAccount}/${bizId}`,
      params,
      config
    )
  },
  ...
  archiveBusiness({ commit, state, dispatch, rootGetters }, bizId) {
    return $http.put(
      `biz/status/disabled/${rootGetters.supplierAccount}/${bizId}`
    )
  },
  ...
  recoveryBusiness(
    ...
    return $http.put(
      `biz/status/enable/${rootGetters.supplierAccount}/${bizId}`,
      params,
      config
    )
  },
