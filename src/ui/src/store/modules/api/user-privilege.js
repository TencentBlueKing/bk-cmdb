...
const getters = {
  ...
  modelAuthority: (state, getters, rootState, rootGetters) => modelId => {
    ...
    for (const classifyId in modelConfig) {
      if (has(modelConfig[classifyId], modelId)) {
...
const actions = {
  ...
  getRolePrivilege(
    ...
    { bkObjId, bkPropertyId }
  ) {
    return $http.get(
      `topo/privilege/${rootGetters.supplierAccount}/${bkObjId}/${bkPropertyId}`
    )
  },
  ...
  bindRolePrivilege(
    { commit, state, dispatch, rootGetters },
    { bkObjId, bkPropertyId, params, config }
  ) {
    return $http.post(
      `topo/privilege/${rootGetters.supplierAccount}/${bkObjId}/${bkPropertyId}`,
      params,
  ...
  createUserGroup(
    ...
    return $http.post(
      `topo/privilege/group/${rootGetters.supplierAccount}`,
      params,
      config
    )
  },
  ...
  updateUserGroup(
    { commit, state, dispatch, rootGetters },
    { bkGroupId, params, config }
  ) {
    return $http.put(
      `topo/privilege/group/${rootGetters.supplierAccount}/${bkGroupId}`,
      params,
      config
    )
  },
  ...
  searchUserGroup(
    ...
    return $http.post(
      `topo/privilege/group/${rootGetters.supplierAccount}/search`,
      params,
      config
    )
  },
  ...
  searchUserPrivilege(
    ...
    return $http.get(
      `topo/privilege/group/detail/${rootGetters.supplierAccount}/${bkGroupId}`,
      config
    )
  },
  ...
  getUserPrivilege({ commit, state, dispatch, rootGetters }, httpConfig) {
    return $http
      .get(
        `topo/privilege/user/detail/${rootGetters.supplierAccount}/${rootGetters.userName}`,
        httpConfig
      )
      .then(privilege => {
