...
const actions = {
  ...
  createDevice({ commit, state, dispatch, rootGetters }, { params, config }) {
    return $http.post(
      'collector/netcollect/device/action/create',
      params,
      config
    )
  },
  ...
  updateDevice(
    ...
    { deviceId, params, config }
  ) {
    return $http.post(
      `collector/netcollect/device/${deviceId}/action/update`,
      params,
      config
    )
  },
  ...
  searchDevice({ commit, state, dispatch, rootGetters }, { params, config }) {
    return $http.post(
      'collector/netcollect/device/action/search',
      params,
      config
    )
  },
  ...
  getNetDeviceImportTemplate(
    ...
    return $http.get(
      `${window.API_HOST}collector/netcollect/importtemplate/netdevice`,
      config
    )
  },
}
