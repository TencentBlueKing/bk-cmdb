...
const actions = {
  ...
  createNetcollectProperty(
    ...
    return $http.post(
      'collector/netcollect/property/action/create',
      params,
      config
    )
  },
  ...
  updateNetcollectProperty(
    { commit, state, dispatch, rootGetters },
    { propertyId, params, config }
  ) {
    return $http.post(
      `collector/netcollect/property/${propertyId}/action/update`,
      params,
      config
    )
  },
  ...
  searchNetcollectProperty(
    ...
    return $http.post(
      'collector/netcollect/property/action/search',
      params,
      config
    )
  },
   ...
   * @return {promises} promises 对象
   */
  getNetDeviceImportTemplate(
    { commit, state, dispatch, rootGetters },
    { config }
  ) {
    return $http.get(
      `${window.API_HOST}collector/netcollect/importtemplate/netproperty`,
      config
    )
  },
}
