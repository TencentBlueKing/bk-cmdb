...
const getters = {
  ...
  getModelById: (state, getters) => id =>
    getters.models.find(model => model.bk_obj_id === id),
}
...
const actions = {
  ...
  searchClassificationsObjects(
    ...
    return $http
      .post('find/classificationobject', params, config)
      .then(data => {
...
const mutations = {
  ...
  updateClassify(state, classification) {
    ...
    const activeClassification = state.classifications.find(
      ({ bk_classification_id: bkClassificationId }) =>
        bkClassificationId === classification.bk_classification_id
    )
    if (activeClassification) {
      activeClassification.bk_classification_icon =
        classification.bk_classification_icon
      activeClassification.bk_classification_name =
        classification.bk_classification_name
    } else {
  ...
  deleteClassify(state, classificationId) {
    ...
    const index = state.classifications.findIndex(
      ({ bk_classification_id: bkClassificationId }) =>
        bkClassificationId === classificationId
    )
