    ...
    <div class="tab-layout">
      <bk-tab
        ...
        <bk-tab-panel name="nodeInfo" :label="$t('节点信息')">
          <div v-if="!showNodeInfo" class="default-node-info">
            <div class="info-item">
...
export default {
  ...
  computed: {
    ...
    showServiceInstance() {
      return (
        this.selectedNode?.data?.bk_obj_id === BUILTIN_MODELS.MODULE &&
    ...
    emptySet() {
      return (
        this.selectedNode?.data?.bk_obj_id === BUILTIN_MODELS.SET &&
