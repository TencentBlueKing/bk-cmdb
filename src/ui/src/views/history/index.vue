  ...
  <div class="history-layout">
    <div class="history-options">
      ...
      <bk-input
        ...
        class="history-host-filter ml10"
...
export default {
  ...
  watch: {
    objId: {
      ...
      handler(objId) {
        const model =
          this.$store.getters['objectModelClassify/getModelById'](objId) || {}
        this.$store.commit(
          'setTitle',
          `${model.bk_obj_name} ${this.$t('删除历史')}`
        )
      },
    },
  },
  ...
  methods: {
    ...
    async getHistory() {
      try {
        ...
        this.table.stuff.type = this.condition.resource_name
          ? 'search'
          : 'default'
