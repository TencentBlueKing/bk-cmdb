  ...
  <div class="model-export-setting">
    <bk-form
      ...
      <bk-form-item :label="t('压缩包名')" required property="fileName">
        <bk-input
          v-model="settingForm.fileName"
          class="setting-form-input"
          :maxlength="40"
          :show-word-limit="true"
          :placeholder="t('压缩包名仅支持大小写英文字母、数字、- 或 _')" />
      </bk-form-item>
      <bk-form-item :label="t('文件加密')" required>
        <bk-radio-group v-model="isEncrypt" class="encrypt-radio-group">
      ...
      <template v-if="isEncrypt">
        <bk-form-item
          ...
          <bk-input
            ...
            type="password"
            :placeholder="
              t('长度 6-20 个字符，必须包含英文字母、数字和特殊符号')
            "></bk-input>
        </bk-form-item>
        <bk-form-item
          :label="t('二次确认')"
          ...
          icon-offset="-20">
          <bk-input
            v-model="settingForm.confirmedPassword"
            class="setting-form-input"
            type="password"
        ...
        <bk-form-item
          ...
          <bk-input
            ...
            v-model.number="customExpirationTime"
            type="number"
    ...
    watch(
      ...
      () => {
        emit('value-change', {
          ...
          expirationTime:
            settingForm.expirationTime || customExpirationTime.value,
        })
      },
      {
        immediate: true,
