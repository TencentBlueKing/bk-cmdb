...
<template>
  <div class="step-pane">
    ...
    <div class="action-bar">
      <bk-button
        v-show="currentStepIndex < steps.length"
        class="cancel-button"
        @click="cancel"
        >{{ t('取消') }}</bk-button
      >
      <bk-button
        v-show="currentStepIndex > 1 && currentStepIndex < steps.length"
      ...
      <span
        ...
        <bk-button
          v-show="
            currentStepIndex <= steps.length && currentStep.nextButtonVisible
          "
          theme="primary"
          :loading="isLoading"
          :disabled="currentStep.nextButtonDisabled"
