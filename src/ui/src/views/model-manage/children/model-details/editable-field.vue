  ...
  <div
    ...
    <div class="editable-field-container">
      <div class="editable-field-content">
        ...
        <div class="editable-field-control" v-if="editable" v-show="isEditing">
          <bk-input
            v-if="controlName === 'bk-input'"
            v-autofocus
          ...
          <bk-select
            v-if="controlName === 'bk-select' && isEditing"
            :show-on-init="true"
            @change="confirmEdit"
            v-autofocus
            :disabled="isConfirming"
      ...
      <div v-if="editable" v-show="!isEditing" class="editable-field-edit-button">
        <cmdb-auth
          tag="i"
  ...
  export default defineComponent({
    ...
    props: {
      ...
      controlName: {
        type: String,
        default: 'bk-input',
        validator: val => ['bk-input', 'bk-select'].includes(val)
      },
      // 控件属性
      controlAttrs: {
        type: Object,
