...
<template>
  <bk-select
    ...
    <bk-option
      ...
      <div
        :class="['region-info', { selected: selected === region.bk_region }]">
        <span v-bk-overflow-tips class="region-name">{{
          region.bk_region_name
        }}</span>
  ...
  methods: {
    ...
    getRegionInfo() {
      const region = this.regions.find(
        region => region.bk_region === this.value
      )
