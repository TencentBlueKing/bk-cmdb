...
<template>
  <div v-bkloading="{ isLoading: loading }" class="landing-layout">
    <bk-exception v-if="notFound" type="404">
      <span>{{ $t('未查询到主机') }}</span>
    </bk-exception>
    <div v-else-if="error" class="bk-exception">
