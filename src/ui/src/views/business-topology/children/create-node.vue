    ...
    <div
      ...
      <div
        ...
        :class="[
          'form-group',
          {
            'form-group-flex':
              ...
              property['bk_property_type'] === 'longchar',
          },
        ]">
        <label
          :class="[
        ...
        <component
          ...
          v-if="!['longchar'].includes(property['bk_property_type'])"
