...
<template>
  <div
        ...
        <div
          ...
          <bk-big-tree
            ...
            <template slot-scope="{ node, data }">
              ...
              <i
                v-else
                :class="['node-icon fl', { 'is-template': isTemplate(data) }]"
                >{{ data.bk_obj_name[0] }}</i
              >
    ...
    <div class="layout-footer">
      <span v-bk-tooltips="confirmTooltips" class="footer-tips mr10">
        <bk-button
          theme="primary"
...
export default {
  ...
  computed: {
    ...
    hasDifference() {
      const checkedModules = this.checked
