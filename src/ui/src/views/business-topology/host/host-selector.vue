...
<template>
  <div
    ...
    class="host-selector-layout clearfix">
      ...
      <div class="wrapper-column wrapper-left fl">
        ...
        <keep-alive>
          <component
            :is="activeComponent"
            ref="dynamic"
            class="selector-component"></component>
        </keep-alive>
      </div>
        ...
        <bk-table
          ...
          <bk-table-column :label="$t('内网IP')">
            <template slot-scope="{ row }">
              ...
              <span v-if="repeatSelected.includes(row)" class="repeat-row">{{
                $t('IP重复')
              }}</span>
            </template>
          </bk-table-column>
          ...
          <bk-table-column :label="$t('操作')">
            <bk-button slot-scope="{ row }" text @click="handleRemove(row)">{{
              $t('移除')
            }}</bk-button>
          </bk-table-column>
        </bk-table>
