      ...
      <bk-tab-panel
        ...
        <div class="tab-content">
          <div
            ...
            <cmdb-auth
              v-if="['idle', 'business'].includes(panel.props.name)"
            ...
            <component
              ...
              v-if="authorized[panel.props.name] !== false"
...
export default {
  ...
  computed: {
    ...
    availableTabList() {
      ...
      this.tab.list.forEach(tab => {
        ...
        if (tab.props.name !== 'acrossBusiness') {
          ...
          const firstSelectionModules = this.modules
          ...
          tab.component.props.confirmText =
            tab.props.name === 'idle' && this.isIdleSetModules
              ? this.$t('确定')
              : ''
    ...
    activeTab() {
      return this.availableTabList.find(
        tab => tab.props.name === this.tab.active
      )
    },
    auth() {
      return [
  ...
  methods: {
    ...
    handleConfirm() {
      ...
      const tab = {
        tabName: currentTab.props.name,
        moduleType: currentTab.component.props.moduleType,
      }
