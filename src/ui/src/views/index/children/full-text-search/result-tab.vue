  ...
  <div class="result-tab">
    <div
      ...
      <span
        ...
        :class="[
          'category-item',
          { 'category-active': category.id === currentCategory },
        ]"
        @click="handleSelectCategory(category)">
        {{ category.name }}（{{ category.count }}）
      </span>
      <div v-show="showMore" class="toggle-anchor" @click="handleToggle">
        <div v-show="!expanded" class="anchor-button">
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const total = computed(() =>
      result.value.total > 999 ? '999+' : result.value.total
    )
