...
<template>
  <div
    ...
    :style="formItemStyle"
    :class="[{ 'indent-line': indentLine }, innerState]">
    <div class="module-builder-content">
      <bk-input
        ...
        :disabled="innerState === 'readonly' || moduleIdDisabled"
        @change="handleModuleIdChange"></bk-input>
      <bk-input
      ...
      <div class="operation">
        <span class="icon-button icon-cc-edit-shape" @click="edit"> </span>
        <span
          v-show="removeable"
          class="icon-button remove-button icon-cc-tips-close"
          @click="remove">
        </span>
        <span class="text-button" @click.stop="confirm">{{ $t('确定') }} </span>
