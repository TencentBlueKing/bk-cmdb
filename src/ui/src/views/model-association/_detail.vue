    ...
    <div class="content-box">
      <label class="form-label">
        ...
        <div
          ...
          <p class="form-error" :title="errors.first('asstId')">
            {{ errors.first('asstId') }}
          </p>
        </div>
      </label>
      ...
      <label class="form-label">
        ...
        <div
          class="cmdb-form-item"
          :class="{ 'is-error': errors.has('srcDes') }">
          <input
      ...
      <label class="form-label">
        ...
        <div
          class="cmdb-form-item"
          :class="{ 'is-error': errors.has('destDes') }">
          <bk-input
      ...
      <div class="radio-box overflow">
        <div class="radio-box overflow">
          ...
          <label class="cmdb-form-radio cmdb-radio-small">
            <input
              v-model="relationInfo.direction"
              type="radio"
              name="direction"
              value="src_to_dest"
              :disabled="isReadOnly || (isEdit && relation.ispre)" />
    ...
    <slot name="operation">
      <div class="btn-group">
        <bk-button
          ...
          :disabled="isReadOnly || (isEdit && relation.ispre)"
          :loading="
            $loading(['updateAssociationType', 'createAssociationType'])
          "
          @click="saveRelation">
          {{ saveBtnText || $t('确定') }}
        </bk-button>
