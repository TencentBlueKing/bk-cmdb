...
<script setup>
  ...
  const optionTypes = ['int', 'float', 'enum', 'enummulti', 'list']
  const getDiffContent = (type, value) => {
    ...
    switch (value) {
      case 'isrequired':
      case 'editable':
        return fieldValue ? t('是') : t('否')
      case 'placeholder':
        return fieldValue || '--'
      case 'option':
        if (optionTypes.includes(bindField.bk_property_type)) return  ''
      case 'default':
        ...
        <div class="diff-table">
          ...
          <div class="table-body">
            <div class="col before-col">
              <div
                :class="['diff-item', {
                  'big-opiton': isShowFieldConfig('before', diff, beforeBindField, optionTypes)
                }]"
            ...
            <div class="col after-col">
              ...
              <div class="col after-col" v-else>
                <div
                  :class="[
                    'diff-item',
                    getAfterBindFieldStyle(diff),
                    {
                      'big-opiton': isShowFieldConfig('after', diff, afterBindField, optionTypes)
                    }
                  ]"
