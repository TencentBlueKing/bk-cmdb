...
// 常规IPV4
export const IPV4_IP = /(?<!\d)(?<ip>(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?))(?!\d)/g

// 常规IPV6
export const IPV6_IP = /(?<![0-9a-fA-F:])(?<ip>([0-9a-fA-F]{4}:){7}[0-9a-fA-F]{4})(?![0-9a-fA-F:])/g

// 管控区域加IPV4
export const AREA_IPV4_IP = /(?<![a-zA-Z0-9.])(?<ip>((\d+):((25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?))|((\d+):\[((25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\]))(?!\d)/g
