...
export const MENU_MODEL_FIELD_TEMPLATE_CREATE =
  'menu_model_field_template_create'
export const MENU_MODEL_FIELD_TEMPLATE_CREATE_BASIC =
  'menu_model_field_template_create_basic'
export const MENU_MODEL_FIELD_TEMPLATE_CREATE_FIELD_SETTINGS =
...
export const MENU_MODEL_FIELD_TEMPLATE_EDIT_BASIC =
  'menu_model_field_template_edit_basic'
export const MENU_MODEL_FIELD_TEMPLATE_EDIT_FIELD_SETTINGS =
  'menu_model_field_template_edit_field_settings'
export const MENU_MODEL_FIELD_TEMPLATE_EDIT_BINDING =
  'menu_model_field_template_edit_binding'
export const MENU_MODEL_FIELD_TEMPLATE_BIND = 'menu_model_field_template_bind'
export const MENU_MODEL_FIELD_TEMPLATE_SYNC_MODEL =
