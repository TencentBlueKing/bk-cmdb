...
func TestCreateClassification(t *testing.T) {
	...
	id, err := cli.CCV3(client.Params{}).Classification().CreateClassification(types.MapStr{
...
func TestDeleteClassification(t *testing.T) {
	...
	err := cli.CCV3(client.Params{}).Classification().DeleteClassification(cond)
...
func TestUpdateClassification(t *testing.T) {
	...
	err := cli.CCV3(client.Params{}).Classification().UpdateClassification(types.MapStr{"bk_classification_name": "test_update"}, cond)
...
func TestSearchClassification(t *testing.T) {
	...
	dataMap, err := cli.CCV3(client.Params{}).Classification().SearchClassifications(cond)
...
func TestSearchClassificationWithObjects(t *testing.T) {
	...
	dataMap, err := cli.CCV3(client.Params{}).Classification().SearchClassificationWithObjects(cond)
