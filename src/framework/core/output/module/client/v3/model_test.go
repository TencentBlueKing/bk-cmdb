...
func TestCreateObject(t *testing.T) {
	...
	id, err := cli.CCV3(client.Params{}).Model().CreateObject(types.MapStr{
...
func TestDeleteObject(t *testing.T) {
	...
	err := cli.CCV3(client.Params{}).Model().DeleteObject(cond)
...
func TestUpdateObject(t *testing.T) {
	...
	err := cli.CCV3(client.Params{}).Model().UpdateObject(types.MapStr{"bk_obj_name": "test_update"}, cond)
...
func TestSearchObject(t *testing.T) {
	...
	dataMap, err := cli.CCV3(client.Params{}).Model().SearchObjects(cond)
