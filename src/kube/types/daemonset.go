...
type DaemonSet struct {
	...
	StrategyType          *DaemonSetUpdateStrategyType `json:"strategy_type" bson:"strategy_type"`
	RollingUpdateStrategy *RollingUpdateDaemonSet      `json:"rolling_update_strategy" bson:"rolling_update_strategy"`
}
...
func (d *DaemonSetUpdateData) BuildUpdateData() (map[string]interface{}, error) {
	now := time.Now().Unix()
