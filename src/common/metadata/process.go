...
type Process struct {
	...
	ProcessID       int       `field:"bk_process_id" json:"bk_process_id" bson:"bk_process_id"`
	...
	BindIP          string    `field:"bind_ip" json:"bind_ip" bson:"bind_ip"`
	...
	Timeout         int64     `field:"timeout" json:"timeout" bson:"timeout"`
