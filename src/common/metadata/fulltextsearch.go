...
type ESIndexMetaSettings struct {
	...
	//PropertyAnalyzer string `json:"analyzer"`
}
...
type ESIndexMetaMappingsProperty struct {
	...
	// PropertyAnalyzer elastic index property type. Support 'ik_max_word' 'ik_smart'.
	PropertyAnalyzer string `json:"analyzer,omitempty"`

	// PropertyAnalyzer elastic query property type. Support 'ik_max_word' 'ik_smart'.
	PropertySearchAnalyzer string `json:"search_analyzer,omitempty"`
}
