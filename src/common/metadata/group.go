...
type Group struct {
	ID         int64  `field:"id,omitempty" json:"id" bson:"id"`
	GroupID    string `field:"bk_group_id,omitempty" json:"bk_group_id" bson:"bk_group_id"`
	GroupName  string `field:"bk_group_name,omitempty" json:"bk_group_name" bson:"bk_group_name"`
	GroupIndex int64  `field:"bk_group_index,omitempty" json:"bk_group_index" bson:"bk_group_index"`
	ObjectID   string `field:"bk_obj_id,omitempty" json:"bk_obj_id" bson:"bk_obj_id"`
	OwnerID    string `field:"bk_supplier_account,omitempty" json:"bk_supplier_account" bson:"bk_supplier_account"`
	IsDefault  bool   `field:"bk_isdefault,omitempty" json:"bk_isdefault" bson:"bk_isdefault"`
	IsPre      bool   `field:"ispre,omitempty" json:"ispre" bson:"ispre"`
}
