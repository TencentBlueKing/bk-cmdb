...
var ModelQuoteAuthConfigs = []AuthConfig{
	{
		...
		Pattern:        "/createmany/quoted/instance",
		HTTPMethod:     http.MethodPost,
		ResourceType:   meta.ModelInstanceTopology,
		ResourceAction: meta.SkipAction,
	},
	{
		Name:           "ListQuotedInstance",
		Description:    "查询引用模型实例列表",
		Pattern:        "/findmany/quoted/instance",
		HTTPMethod:     http.MethodPost,
		ResourceType:   meta.ModelInstanceTopology,
		ResourceAction: meta.SkipAction,
	},
	{
		...
		Pattern:        "/updatemany/quoted/instance",
	...
	},
	{
		...
		Pattern:        "/deletemany/quoted/instance",
