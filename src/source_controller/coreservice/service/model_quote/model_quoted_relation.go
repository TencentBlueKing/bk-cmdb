...
func (s *service) ListModelQuoteRelation(cts *rest.Contexts) {
...
func (s *service) CreateModelQuoteRelation(cts *rest.Contexts) {
	relations := make([]metadata.ModelQuoteRelation, 0)
...
func (s *service) DeleteModelQuoteRelation(cts *rest.Contexts) {
