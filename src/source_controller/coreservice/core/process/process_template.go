...
func (p *processOperation) UpdateProcessTemplate(ctx core.ContextParams, templateID int64, template metadata.ProcessTemplate) (*metadata.ProcessTemplate, error) {
	return nil, nil
}
