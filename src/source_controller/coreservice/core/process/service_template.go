...
func (p *processOperation) UpdateServiceTemplate(ctx core.ContextParams, templateID int64, template metadata.ServiceTemplate) (*metadata.ServiceTemplate, error) {
	return nil, nil
}

func (p *processOperation) ListServiceTemplates(ctx core.ContextParams, bizID int64, categoryID int64) (*metadata.MultipleServiceTemplate, error) {
	return nil, nil
}
