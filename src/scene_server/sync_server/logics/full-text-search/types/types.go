...
var (
	...
	IndexVersionMap = map[string]string{
		metadata.IndexNameBizSet:         "20250317",
		metadata.IndexNameBiz:            "20250317",
		metadata.IndexNameSet:            "20250317",
		metadata.IndexNameModule:         "20250317",
		metadata.IndexNameHost:           "20250317",
		metadata.IndexNameModel:          "20250317",
		metadata.IndexNameObjectInstance: "20250317",
	}
...
// SyncDataI defines the full-text search data synchronization interface
type SyncDataI interface {
