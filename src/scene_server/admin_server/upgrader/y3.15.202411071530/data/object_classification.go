...
var objClassificationDataData = []metadata.Classification{
	{
...
func addObjClassificationData(kit *rest.Kit, db dal.Dal) error {
	...
	var objClassification []interface{}
	var objClassificationAudit []tools.AuditField
	for _, asst := range objClassificationDataData {
		objClassification = append(objClassification, asst)
		objClassificationAudit = append(objClassificationAudit, tools.AuditField{
			AuditType:    metadata.ModelType,
			ResourceType: metadata.ModelClassificationRes,
			ResourceName: asst.ClassificationName,
		})
	}
