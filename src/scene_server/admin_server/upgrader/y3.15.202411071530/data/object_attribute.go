...
func addObjAttrData(kit *rest.Kit, db dal.Dal) error {
	...
	var attributeAudit []tools.AuditType
	for _, attr := range objAttrData {
		...
		attributeAudit = append(attributeAudit, tools.AuditType{
