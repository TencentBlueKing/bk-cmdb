...
func addBizSetData(kit *rest.Kit, db dal.Dal) error {
	...
	cmpField := &tools.CmpFiled{
		...
		IDField:      common.BKBizSetIDField,
	}
	auditDataField := &tools.AuditDataField{
		BusinessID:   "",
		ResourceID:   "bk_biz_set_id",
		ResourceName: "bk_biz_set_name",
	}
	_, err := tools.InsertData(kit, db.Shard(kit.ShardOpts()), common.BKTableNameBaseBizSet,
		[]interface{}{bizSetData}, cmpField, []tools.AuditType{bizSetAudit}, auditDataField)
	if err != nil {
