...
func addBizSetData(kit *rest.Kit, db dal.Dal) error {
	...
	cmpField := &tools.CmpFiled{
		Unique:     []string{common.BKBizSetNameField},
		IgnoreKeys: []string{common.BKBizSetIDField},
		ID:         common.BKBizSetIDField,
	}
	_, err := tools.InsertData(kit, db.Shard(kit.ShardOpts()), common.BKTableNameBaseBizSet,
		[]interface{}{bizSetData}, cmpField, []tools.AuditField{bizSetAudit})
	if err != nil {
