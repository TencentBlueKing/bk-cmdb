...
var (
	...
	objAttDesIndexes = []types.Index{
		...
		},
		{
			...
			Keys:                    bson.D{{"bk_template_id", 1}, {"bk_supplier_account", 1}},
			Background:              true,
			PartialFilterExpression: make(map[string]interface{}),
		},
		{
	...
	bizSetBaseIndexes = []types.Index{
		...
		},
		{
			...
			Keys:                    bson.D{{"bk_biz_set_id", 1}, {"bk_biz_set_name", 1}, {"bk_supplier_account", 1}},
			Background:              true,
			PartialFilterExpression: make(map[string]interface{}),
		},
	}
	clusterBaseIndexes = []types.Index{
		...
		{
			Name:                    common.CCLogicIndexNamePrefix + "bkBizID_name_bkSupplierAccount",
			Keys:                    bson.D{{"bk_biz_id", 1}, {"name", 1}, {"bk_supplier_account", 1}},
			Background:              true,
			PartialFilterExpression: make(map[string]interface{}),
		},
		{
		...
		{
			Name:                    common.CCLogicIndexNamePrefix + "xid_bkSupplierAccount",
			Keys:                    bson.D{{"xid", 1}, {"bk_supplier_account", 1}},
			Background:              true,
			PartialFilterExpression: make(map[string]interface{}),
		},
	}
	containerBaseIndexes = []types.Index{
		...
		{
			Name:                    common.CCLogicIndexNamePrefix + "bkPodID_bkSupplierAccount",
			Keys:                    bson.D{{"bk_pod_id", 1}, {"bk_supplier_account", 1}},
			Background:              true,
			PartialFilterExpression: make(map[string]interface{}),
		},
		{
		...
		{
			Name:                    common.CCLogicIndexNamePrefix + "bkClusterID_bkSupplierAccount",
			Keys:                    bson.D{{"bk_cluster_id", 1}, {"bk_supplier_account", 1}},
			Background:              true,
			PartialFilterExpression: make(map[string]interface{}),
		},
		{
			Name:                    common.CCLogicIndexNamePrefix + "bkNamespaceID_bkSupplierAccount",
			Keys:                    bson.D{{"bk_namespace_id", 1}, {"bk_supplier_account", 1}},
			Background:              true,
			PartialFilterExpression: make(map[string]interface{}),
		},
		{
			Name:                    common.CCLogicIndexNamePrefix + "refID_refKind_bkSupplierAccount",
			Keys:                    bson.D{{"ref.id", 1}, {"ref.kind", 1}, {"bk_supplier_account", 1}},
			Background:              true,
			PartialFilterExpression: make(map[string]interface{}),
		},
	}
	cronJobBaseIndexes = []types.Index{
		...
		{
			Name:                    common.CCLogicIndexNamePrefix + "clusterUID_bkSupplierAccount",
			Keys:                    bson.D{{"cluster_uid", 1}, {"bk_supplier_account", 1}},
			Background:              true,
			PartialFilterExpression: make(map[string]interface{}),
		},
		{
		...
		{
			Name:                    common.CCLogicIndexNamePrefix + "name_bkSupplierAccount",
			Keys:                    bson.D{{"name", 1}, {"bk_supplier_account", 1}},
			Background:              true,
			PartialFilterExpression: make(map[string]interface{}),
		},
	}
	...
	fullSyncCondIndexes = []types.Index{
		...
		{
			Name:                    common.CCLogicUniqueIdxNamePrefix + "resource_subResource_bkSupplierAccount",
			Keys:                    bson.D{{"resource", 1}, {"sub_resource", 1}, {"bk_supplier_account", 1}},
			Unique:                  true,
			Background:              true,
	...
	hostBaseIndexes = []types.Index{
		...
		{
			Name:                    common.CCLogicIndexNamePrefix + "bkHostID_bkSupplierAccount",
			Keys:                    bson.D{{"bk_host_id", 1}, {"bk_supplier_account", 1}},
			Background:              true,
			PartialFilterExpression: make(map[string]interface{}),
		},
		{
	...
	modelQuoteRelationIndexes = []types.Index{
		{
			...
			Keys:                    bson.D{{"dest_model", 1}, {"bk_supplier_account", 1}},
			Background:              true,
			PartialFilterExpression: make(map[string]interface{}),
		},
		{
			Name:                    common.CCLogicIndexNamePrefix + "srcModel_bkPropertyID_bkSupplierAccount",
			Keys:                    bson.D{{"src_model", 1}, {"bk_property_id", 1}, {"bk_supplier_account", 1}},
			Background:              true,
			PartialFilterExpression: make(map[string]interface{}),
		},
		{
			Name:                    common.CCLogicIndexNamePrefix + "srcModel_bkSupplierAccount",
			Keys:                    bson.D{{"src_model", 1}, {"bk_supplier_account", 1}},
			Background:              true,
			PartialFilterExpression: make(map[string]interface{}),
		},
	}
	...
	nodeBaseIndexes = []types.Index{
		...
		},
		{
			...
			Keys:                    bson.D{{"bk_biz_id", 1}, {"cluster_uid", 1}, {"bk_supplier_account", 1}},
			Background:              true,
			PartialFilterExpression: make(map[string]interface{}),
		},
		{
			Name:                    common.CCLogicIndexNamePrefix + "bkBizID_bkClusterID_bkSupplierAccount",
			Keys:                    bson.D{{"bk_biz_id", 1}, {"bk_cluster_id", 1}, {"bk_supplier_account", 1}},
			Background:              true,
			PartialFilterExpression: make(map[string]interface{}),
		},
		{
			Name:                    common.CCLogicIndexNamePrefix + "bkBizID_bkHostID_bkSupplierAccount",
			Keys:                    bson.D{{"bk_biz_id", 1}, {"bk_host_id", 1}, {"bk_supplier_account", 1}},
			Background:              true,
			PartialFilterExpression: make(map[string]interface{}),
		},
		{
	...
	podBaseIndexes = []types.Index{
		...
		{
			Name:                    common.CCLogicIndexNamePrefix + "refName_refID_bkSupplierAccount",
			Keys:                    bson.D{{"ref.name", 1}, {"ref.id", 1}, {"bk_supplier_account", 1}},
			Background:              true,
			PartialFilterExpression: make(map[string]interface{}),
		},
		{
	...
	objFieldTemplateRelationIndexes = []types.Index{
		...
		},
		{
			...
			Keys:                    bson.D{{"object_id", 1}, {"bk_supplier_account", 1}},
			Background:              true,
			PartialFilterExpression: make(map[string]interface{}),
		},
	}
	namespaceBaseIndexes = []types.Index{
		...
		{
			Name: common.CCLogicIndexNamePrefix + "clusterID_bkSupplierAccount",
			Keys: bson.D{
				{"bk_cluster_id", 1},
				{"bk_supplier_account", 1},
			},
