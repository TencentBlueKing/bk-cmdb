...
func migrateApiTask(ctx context.Context, db dal.RDB, conf *upgrader.Config) error {
	indexes := map[string]types.Index{
		"idx_taskID": {Name: "idx_taskID", Keys: bson.D{{"task_id", int32(1)}}, Background: true},
		"idx_flag_status_createTime": {Name: "idx_flag_status_createTime", Keys: bson.D{{"flag", int32(1)},
			{"status", int32(1)}, {"create_time", int32(1)}}, Background: true},
		"idx_lastTime_status": {Name: "idx_lastTime_status", Keys: bson.D{{"last_time", int32(1)},
			{"status", int32(1)}}, Background: true},
		"idx_lastTime": {Name: "idx_lastTime", Keys: bson.D{{"last_time", int32(1)}}},
	}
...
func migrateAPITaskSyncStatus(ctx context.Context, db dal.RDB, conf *upgrader.Config) error {
	...
	indexes := map[string]types.Index{
		"idx_instID_flag_createTime": {Name: "idx_instID_flag_createTime", Keys: bson.D{{"bk_inst_id", int32(1)},
			{"flag", int32(1)}, {"create_time", int32(1)}}, Background: true},
		"idx_lastTime": {Name: "idx_lastTime", Keys: bson.D{{"last_time", int32(1)}},
