...
func initPlatAttr(ctx context.Context, db dal.RDB, conf *upgrader.Config) error {
	...
	dataRows := []*Attribute{
		...
		{ObjectID: objID, PropertyID: "bk_region", PropertyName: "VPV所属区域", IsRequired: false, IsOnly: false, IsEditable: true, PropertyGroup: groupBaseInfo, PropertyType: common.FieldTypeSingleChar, Option: ""},
