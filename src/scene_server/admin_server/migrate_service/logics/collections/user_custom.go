...
type migrateUserCustom struct {
	tableName string
}

// createTable create table
func (m *migrateUserCustom) createTable(ownerID string, metaData dbStorage.DI, instData dbStorage.DI) error {
...
func init() {
	m := &migrateUserCustom{tableName: "cc_UserCustom"}
