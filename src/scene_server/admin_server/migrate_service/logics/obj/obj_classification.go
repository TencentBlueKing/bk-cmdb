...
type migrateObjClassification struct {
	tableName string
}

// createTable create table
func (m *migrateObjClassification) createTable(ownerID string, metaData dbStorage.DI, instData dbStorage.DI) error {
...
func (m *migrateObjClassification) AddData(ownerID string, metaData dbStorage.DI, instData dbStorage.DI) error {
	err := models.AddObjClassificationData(m.tableName, metaData)
	return err
}

func init() {
	m := &migrateObjClassification{tableName: "cc_ObjClassification"}
