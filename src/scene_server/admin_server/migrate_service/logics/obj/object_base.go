...
type migrateObjectBase struct {
	tableName string
}

// createTable create table
func (m *migrateObjectBase) createTable(ownerID string, metaData dbStorage.DI, instData dbStorage.DI) error {
...
func init() {
	m := &migrateObjectBase{tableName: "cc_ObjectBase"}
