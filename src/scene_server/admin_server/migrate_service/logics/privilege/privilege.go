...
type migratePrivilege struct {
	tableName string
}

// createTable create table
func (m *migratePrivilege) createTable(ownerID string, metaData dbStorage.DI, instData dbStorage.DI) error {
...
func init() {
	m := &migratePrivilege{tableName: "cc_Privilege"}
