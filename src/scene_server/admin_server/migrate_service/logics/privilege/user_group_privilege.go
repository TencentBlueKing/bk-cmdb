...
type migrateUserGroupPrivilege struct {
	tableName string
}

// createTable create table
func (m *migrateUserGroupPrivilege) createTable(ownerID string, metaData dbStorage.DI, instData dbStorage.DI) error {
...
func init() {
	m := &migrateUserGroupPrivilege{tableName: "cc_UserGroupPrivilege"}
