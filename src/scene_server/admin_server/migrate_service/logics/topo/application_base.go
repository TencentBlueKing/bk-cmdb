...
type migrateApplictaonBase struct {
	tableName string
}

// createTable create table
func (m *migrateApplictaonBase) createTable(ownerID string, metaData dbStorage.DI, instData dbStorage.DI) error {
...
func init() {
	m := &migrateApplictaonBase{tableName: "cc_ApplicationBase"}
