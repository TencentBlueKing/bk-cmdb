...
type migrateSetBase struct {
	tableName string
}

// createTable create table
func (m *migrateSetBase) createTable(ownerID string, metaData dbStorage.DI, instData dbStorage.DI) error {
...
func init() {
	mSet := &migrateSetBase{tableName: "cc_SetBase"}
