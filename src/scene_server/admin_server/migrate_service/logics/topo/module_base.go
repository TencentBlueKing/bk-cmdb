...
type migrateModuleBase struct {
	tableName string
}

// createTable create table
func (m *migrateModuleBase) createTable(ownerID string, metaData dbStorage.DI, instData dbStorage.DI) error {
...
func init() {
	mModule := &migrateModuleBase{tableName: "cc_ModuleBase"}
