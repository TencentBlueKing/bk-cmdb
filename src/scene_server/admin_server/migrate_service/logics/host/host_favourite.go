...
type migrateHostFavourite struct {
	tableName string
}

// createTable create table
func (m *migrateHostFavourite) createTable(ownerID string, metaData dbStorage.DI, instData dbStorage.DI) error {
...
func init() {
	m := &migrateHostFavourite{tableName: "cc_HostFavourite"}
