...
type migrateHoistory struct {
	tableName string
}

// createTable create table
func (m *migrateHoistory) createTable(ownerID string, metaData dbStorage.DI, instData dbStorage.DI) error {
...
func init() {
	m := &migrateHoistory{tableName: "cc_History"}
