...
type migrateProcModule struct {
	tableName string
}

// createTable create table
func (m *migrateProcModule) createTable(ownerID string, metaData dbStorage.DI, instData dbStorage.DI) error {
...
func init() {
	m := &migrateProcModule{tableName: "cc_Proc2Module"}
