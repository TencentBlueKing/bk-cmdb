...
func addDefaultBiz(db storage.DI, conf *upgrader.Config) error {
	...
	_, _, err = upgrader.Upsert(db, "cc_ModuleBase", defaultResModule, common.BKModuleIDField, []string{common.BKOwnerIDField, common.BKDefaultField}, append(filled, common.BKModuleIDField))
	if err != nil {
	...
	_, _, err = upgrader.Upsert(db, "cc_ModuleBase", defaultFaultModule, common.BKModuleIDField, []string{common.BKOwnerIDField, common.BKDefaultField}, append(filled, common.BKModuleIDField))
	if err != nil {
