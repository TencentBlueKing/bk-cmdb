...
func addDefaultBiz(db storage.DI, conf *upgrader.Config) error {
	...
	bizID, _, err = upgrader.Upsert(db, "cc_ApplicationBase", defaultBiz, common.BKAppIDField, []string{common.BKOwnerIDField, common.BKDefaultField}, append(filled, common.BKAppIDField))
	if err != nil {
	...
	setID, _, err = upgrader.Upsert(db, "cc_SetBase", defaultSet, common.BKSetIDField, []string{common.BKOwnerIDField, common.BKDefaultField}, append(filled, common.BKSetIDField))
	if err != nil {
	...
	defaultResModuleID, _, err = upgrader.Upsert(db, "cc_ModuleBase", defaultResModule, common.BKModuleIDField, []string{common.BKOwnerIDField, common.BKDefaultField}, append(filled, common.BKModuleIDField))
	if err != nil {
	...
	defaultFaultModuleID, _, err = upgrader.Upsert(db, "cc_ModuleBase", defaultFaultModule, common.BKModuleIDField, []string{common.BKOwnerIDField, common.BKDefaultField}, append(filled, common.BKModuleIDField))
	if err != nil {
