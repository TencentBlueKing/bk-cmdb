...
func getPropertyGroupData(ownerID string) []*metadata.PropertyGroup {
	...
	dataRows := []*metadata.PropertyGroup{
		...
		&metadata.PropertyGroup{ObjectID: common.BKInnerObjIDHost, GroupID: mCommon.HostTopology, GroupName: mCommon.HostTopologyName, GroupIndex: 2, OwnerID: ownerID, IsDefault: true},
