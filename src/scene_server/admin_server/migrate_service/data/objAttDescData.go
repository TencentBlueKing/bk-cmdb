...
func HostRow() []*metadata.ObjectAttDes {
	...
	dataRows := []*metadata.ObjectAttDes{
		...
		&metadata.ObjectAttDes{ObjectID: objID, PropertyID: "bk_client.GetClient().CCV3()", PropertyName: "操作系统位数", IsRequired: false, IsOnly: false, PropertyGroup: groupAgent, PropertyType: common.FieldTypeSingleChar, Option: ""},
