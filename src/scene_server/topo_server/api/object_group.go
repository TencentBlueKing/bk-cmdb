...
func (cli *topoAPI) CreateObjectGroup(params core.LogicParams, data frtypes.MapStr) (frtypes.MapStr, error) {
	return nil, nil
}

// UpdateObjectGroup update the object group information
func (cli *topoAPI) UpdateObjectGroup(params core.LogicParams, data frtypes.MapStr) (frtypes.MapStr, error) {
	return nil, nil
}

// DeleteObjectGroup delete the object group
func (cli *topoAPI) DeleteObjectGroup(params core.LogicParams, data frtypes.MapStr) (frtypes.MapStr, error) {
	return nil, nil
}

// UpdateObjectAttributeGroup update the object attribute belongs to group information
func (cli *topoAPI) UpdateObjectAttributeGroup(params core.LogicParams, data frtypes.MapStr) (frtypes.MapStr, error) {
	return nil, nil
}

// DeleteObjectAttributeGroup delete the object attribute belongs to group information
func (cli *topoAPI) DeleteObjectAttributeGroup(params core.LogicParams, data frtypes.MapStr) (frtypes.MapStr, error) {
	return nil, nil
}

// SearchGroupByObject search the groups by the object
func (cli *topoAPI) SearchGroupByObject(params core.LogicParams, data frtypes.MapStr) (frtypes.MapStr, error) {
	return nil, nil
}
