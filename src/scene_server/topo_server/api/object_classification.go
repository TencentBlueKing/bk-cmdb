...
func (cli *topoAPI) CreateClassification(params core.LogicParams, data frtypes.MapStr) (frtypes.MapStr, error) {
	return nil, nil
}

// SearchClassificationWithObjects search the classification with objects
func (cli *topoAPI) SearchClassificationWithObjects(params core.LogicParams, data frtypes.MapStr) (frtypes.MapStr, error) {
	return nil, nil
}

// SearchClassification search the classifications
func (cli *topoAPI) SearchClassification(params core.LogicParams, data frtypes.MapStr) (frtypes.MapStr, error) {
	return nil, nil
}

// UpdateClassification update the object classification
func (cli *topoAPI) UpdateClassification(params core.LogicParams, data frtypes.MapStr) (frtypes.MapStr, error) {
	return nil, nil
}

// DeleteClassification delete the object classification
func (cli *topoAPI) DeleteClassification(params core.LogicParams, data frtypes.MapStr) (frtypes.MapStr, error) {
	return nil, nil
}
