...
func (cli *topoAPI) CreateBusiness(params core.LogicParams, data frtypes.MapStr) (frtypes.MapStr, error) {

	return nil, nil
}

// DeleteBusiness delete the business
func (cli *topoAPI) DeleteBusiness(params core.LogicParams, data frtypes.MapStr) (frtypes.MapStr, error) {
	return nil, nil
}

// UpdateBusiness update the business
func (cli *topoAPI) UpdateBusiness(params core.LogicParams, data frtypes.MapStr) (frtypes.MapStr, error) {
	return nil, nil
}

// UpdateBusinessStatus update the business status
func (cli *topoAPI) UpdateBusinessStatus(params core.LogicParams, data frtypes.MapStr) (frtypes.MapStr, error) {
	return nil, nil
}

// SearchBusiness search the business by condition
func (cli *topoAPI) SearchBusiness(params core.LogicParams, data frtypes.MapStr) (frtypes.MapStr, error) {
	return nil, nil
}

// SearchDefaultBusiness search the business by condition
func (cli *topoAPI) SearchDefaultBusiness(params core.LogicParams, data frtypes.MapStr) (frtypes.MapStr, error) {
	return nil, nil
}

// CreateDefaultBusiness create the default business
func (cli *topoAPI) CreateDefaultBusiness(params core.LogicParams, data frtypes.MapStr) (frtypes.MapStr, error) {
	return nil, nil
}
