...
type AssociationOperationInterface interface {
	...
	SearchMainlineAssociationInstTopo(params types.ContextParams, objID string, instID int64, withStatistics bool, withDefault bool) ([]*metadata.TopoInstRst, error)
