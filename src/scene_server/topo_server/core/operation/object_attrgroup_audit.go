...
func (log *ObjectAttrGroupAudit) SaveAuditLog(auditAction metadata.ActionType) {
	...
	//get objectName
	log.getObjectInfo(log.kit, log.bkObjectID)
...
func (log *ObjectAttrGroupAudit) getObjectInfo(kit *rest.Kit, bkObjectID string) {
