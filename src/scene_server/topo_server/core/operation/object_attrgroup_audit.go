...
func NewObjectAttrGroupAudit(clientSet apimachinery.ClientSetInterface) *ObjectAttrGroupAudit {
...
func (log *ObjectAttrGroupAudit) WithPrevious(kit *rest.Kit, id int64) errors.CCError {
...
func (log *ObjectAttrGroupAudit) MakeCurrent(curData map[string]interface{}) errors.CCError {
	log.curData = curData
	return nil
}

func (log *ObjectAttrGroupAudit) WithCurrent(kit *rest.Kit, id int64) errors.CCError {
...
func (log *ObjectAttrGroupAudit) SaveAuditLog(kit *rest.Kit, auditAction metadata.ActionType) errors.CCError {
...
func (log *ObjectAttrGroupAudit) buildLogData(kit *rest.Kit, ID int64) (map[string]interface{}, errors.CCError) {
...
func (log *ObjectAttrGroupAudit) GetObjectInfo(kit *rest.Kit, objectID string) errors.CCError {
