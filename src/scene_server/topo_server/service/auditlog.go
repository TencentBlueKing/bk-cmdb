...
func (s *Service) SearchAuditList(ctx *rest.Contexts) {
	...
	fields := []string{common.BKFieldID, common.BKResourceTypeField, common.BKActionField, common.BKOperationTimeField,
		common.BKAppIDField, common.BKResourceIDField, common.BKResourceNameField,
