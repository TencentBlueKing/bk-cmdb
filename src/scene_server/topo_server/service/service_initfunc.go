...
func (s *Service) initModule(web *restful.WebService) {
	...
	utility.AddHandler(rest.Action{Verb: http.MethodPost, Path: "/module/search/bk_biz_id/{bk_biz_id}", Handler: s.SearchModuleBatch})
...
func (s *Service) initSet(web *restful.WebService) {
	...
	utility.AddHandler(rest.Action{Verb: http.MethodPost, Path: "/set/search/bk_biz_id/{bk_biz_id}", Handler: s.SearchSetBatch})
