...
// Service wraps a restful web service
type Service struct {
	*backbone.Engine
	db    dal.RDB
	cache *redis.Client
...
// WebService make a restful.WebService object and setup routes
...
// Healthz used for reporting module state
