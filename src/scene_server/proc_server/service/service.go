...
func (ps *ProcServer) newProcessService(web *restful.WebService) {
	...
	utility.AddHandler(rest.Action{Verb: http.MethodPost, Path: "/findmany/proc/process_instance/detail/by_condition/biz/{bk_biz_id}", Handler: ps.SearchProcessInstances})
