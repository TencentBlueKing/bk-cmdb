...
func (ps *ProcServer) BindModuleProcess(req *restful.Request, resp *restful.Response) {
	...
	// save operation log
	log := common.KvMap{common.BKOpDescField: fmt.Sprintf("build module [%s]", moduleName), common.BKOpTypeField: auditoplog.AuditOpTypeAdd, "inst_id": procID, common.BKContentField: meta.Content{}}
