...
func AddHostV2(CC *api.APIResource, req *restful.Request, appID, hostID, moduleID int, appName, setName, moduleName string, hostAddr, ObjAddr, auditAddr string) error {
