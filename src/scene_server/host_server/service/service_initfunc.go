...
func (s *Service) initFindhost(web *restful.WebService) {
	...
	utility.AddHandler(rest.Action{Verb: http.MethodPost, Path: "/findmany/modulehost", Handler: s.FindModuleHost})
...
func (s *Service) initModule(web *restful.WebService) {
	...
	utility.AddHandler(rest.Action{Verb: http.MethodPost, Path: "/hosts/modules/across/biz/preview", Handler: s.TransferHostAcrossBusinessPreview})
