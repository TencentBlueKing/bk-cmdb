...
type MetaInterface interface {
    ...
    DeleteObjectAttByID(ctx context.Context, objID int, h http.Header, dat map[string]interface{}) (resp *metadata.DeleteResult, err error)
    ...
    UpdateObjectAttByID(ctx context.Context, objID int, h http.Header, dat map[string]interface{}) (resp *metadata.UpdateResult, err error)
}
