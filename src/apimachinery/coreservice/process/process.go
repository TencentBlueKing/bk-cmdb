...
type ProcessInterface interface {
	...
	ListServiceInstanceDetail(ctx context.Context, h http.Header, option *metadata.ListServiceInstanceDetailOption) (*metadata.MultipleServiceInstance, errors.CCErrorCoder)
