...
type ObjectInterface interface {
    ...
    SelectModel(ctx context.Context, ownerID string, h http.Header) (resp *metadata.Response, err error)
    ...
    CreateObjectAtt(ctx context.Context, h http.Header, obj *obj.ObjAttDes) (resp *metadata.Response, err error)
    ...
    CreateClassification(ctx context.Context, h http.Header, obj *sencapi.ObjectClsDes) (resp *metadata.Response, err error)
    ...
    CreatePropertyGroup(ctx context.Context, h http.Header, dat obj.ObjAttGroupDes) (resp *metadata.Response, err error)
    ...
    CreateObject(ctx context.Context, h http.Header, obj sencapi.ObjectDes) (resp *metadata.Response, err error)
