...
public:
    ...
    void SetExterntions(std::vector<std::string>& externstions);
    ...
    void SetBody(const char* ptrValue, uint32_t valueLength, GSEDataPackageExtension* ptrExtension /*= NULL*/);
    void setExtension(GSEDataPackageExtension* ptrExtension);
