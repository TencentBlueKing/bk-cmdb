...
struct PulsarProducerObject
{
    ...
    PulsarProducerObject(pulsar_producer_t* producer, pulsar_producer_configuration_t* conf): m_producer(producer), m_producer_conf(conf) {}
...
private:
    ...
    std::map<std::string, PulsarProducerObject> m_producers;
};
