...
#ifndef SOURCE_COMMON_OPS_OPSCLIENT_H_
#define SOURCE_COMMON_OPS_OPSCLIENT_H_
...
//#include "dynamic_protocol/data_package.h"
//#include "dynamic_protocol/data_extension.h"
#include "protocol.h"
...
{
public:
    OPSServerAddress(const std::string &ip, uint16_t port) : m_hostIP(ip), m_hostPort(port){};
