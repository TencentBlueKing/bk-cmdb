...
#ifndef _GSE_DATA_CHANNELID_DELTE_API_H_
#define _GSE_DATA_CHANNELID_DELTE_API_H_
...
public:
    ...
    std::shared_ptr<DeleteSpecification> m_ptrDeleteSpecification;
...
const std::string ChannelIdDeleteHandlerURI = "/dataroute/v1/delete_route";
const std::string ChannelIdDeleteHandlerURIV2 = "/api/v2/data/config/delete_route";

class ChannelIdDeleteAPIHandler : public gse::net::http::HTTPHandler
{

public:
    ChannelIdDeleteAPIHandler(const std::string &version = "v2");
    virtual ~ChannelIdDeleteAPIHandler();
...
private:
    ...
    const std::string m_metricsApiName = {"delete_route"};
