...
func (s *service) getPlats(req *restful.Request, resp *restful.Response) {
	...
	result, err := s.Engine.CoreAPI.HostServer().GetPlat(srvData.ctx, srvData.header)
	if err != nil {
...
func (s *service) deletePlats(req *restful.Request, resp *restful.Response) {
	...
	result, err := s.Engine.CoreAPI.HostServer().DelPlat(srvData.ctx, platID, srvData.header)
	if err != nil {
...
func (s *service) createPlats(req *restful.Request, resp *restful.Response) {
	...
	result, err := s.Engine.CoreAPI.HostServer().CreatePlat(srvData.ctx, srvData.header, param)
	if nil != err {
