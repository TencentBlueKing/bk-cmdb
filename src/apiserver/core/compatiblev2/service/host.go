...
func (s *service) updateHostStatus(req *restful.Request, resp *restful.Response) {
	...
	result, err := s.Engine.CoreAPI.HostServer().UpdateHost(srvData.ctx, appID, srvData.header, param)
	if err != nil {
...
func (s *service) updateHostByAppID(req *restful.Request, resp *restful.Response) {
	...
	result, err := s.Engine.CoreAPI.HostServer().UpdateHostByAppID(srvData.ctx, appID, srvData.header, param)
	if err != nil {
...
func (s *service) getCompanyIDByIps(req *restful.Request, resp *restful.Response) {
	...
	result, err := s.Engine.CoreAPI.HostServer().HostSearchByIP(srvData.ctx, srvData.header, param)
	if err != nil {
...
func (s *service) getHostListByAppIDAndField(req *restful.Request, resp *restful.Response) {
	...
	result, err := s.Engine.CoreAPI.HostServer().GetHostListByAppidAndField(srvData.ctx, appID, converter.ConverterV2FieldsToV3(field, common.BKInnerObjIDHost), srvData.header)
	if err != nil {
...
func (s *service) updateHostModule(req *restful.Request, resp *restful.Response) {
	...
	case NormalTrans:
		result, err = s.Engine.CoreAPI.HostServer().HostModuleRelation(srvData.ctx, srvData.header, input)
	case EmptyTrans:
		result, err = s.Engine.CoreAPI.HostServer().MoveHost2EmptyModule(srvData.ctx, srvData.header, &hostModuleParam)
	case FaultTrans:
...
func (s *service) updateCustomProperty(req *restful.Request, resp *restful.Response) {
	...
	result, err := s.Engine.CoreAPI.HostServer().UpdateCustomProperty(srvData.ctx, srvData.header, param)
	if err != nil {
...
func (s *service) cloneHostProperty(req *restful.Request, resp *restful.Response) {
	...
	result, err := s.Engine.CoreAPI.HostServer().CloneHostProperty(srvData.ctx, srvData.header, &param)
	if err != nil {
...
func (s *service) delHostInApp(req *restful.Request, resp *restful.Response) {
	...
	result, err := s.Engine.CoreAPI.HostServer().DelHostInApp(srvData.ctx, srvData.header, param)
	if err != nil {
...
func (s *service) getGitServerIp(req *restful.Request, resp *restful.Response) {
	...
	result, err := s.Engine.CoreAPI.HostServer().GetGitServerIp(srvData.ctx, srvData.header, param)
	if err != nil {
