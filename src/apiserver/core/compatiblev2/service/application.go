...
func (s *service) getAppList(req *restful.Request, resp *restful.Response) {
	...
	result, err := s.Engine.CoreAPI.TopoServer().Instance().SearchApp(srvData.ctx, srvData.ownerID, srvData.header, param)
	if err != nil {
...
func (s *service) addApp(req *restful.Request, resp *restful.Response) {
	...
	result, err := s.Engine.CoreAPI.TopoServer().Instance().CreateApp(srvData.ctx, srvData.ownerID, srvData.header, param)
	if nil != err {
...
func (s *service) deleteApp(req *restful.Request, resp *restful.Response) {
	...
	result, err := s.Engine.CoreAPI.TopoServer().Instance().DeleteApp(srvData.ctx, appID, srvData.ownerID, srvData.header)
	if nil != err {
...
func (s *service) editApp(req *restful.Request, resp *restful.Response) {
	...
	result, err := s.Engine.CoreAPI.TopoServer().Instance().UpdateApp(srvData.ctx, srvData.ownerID, appID, srvData.header, param)
	if nil != err {
...
func (s *service) getHostAppByCompanyId(req *restful.Request, resp *restful.Response) {
	...
	result, err := s.Engine.CoreAPI.HostServer().GetHostAppByCompanyId(srvData.ctx, srvData.header, param)
	if nil != err {
