...
func (s *Service) Healthz(c *gin.Context) {
	...
	apiServer := metric.HealthItem{IsHealthy: true, Name: types.CCModuleApi}
	if _, err := s.Engine.CoreAPI.Healthz().HealthCheck(types.CCModuleApi); err != nil {
