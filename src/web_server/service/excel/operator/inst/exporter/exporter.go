...
func (e *Exporter) getInst(cond mapstr.MapStr) ([]mapstr.MapStr, error) {
	...
	case common.BKInnerObjIDApp:
		return e.GetClient().GetInnerObjectInst(e.GetKit(), common.BKInnerObjIDApp, cond)
	case common.BKInnerObjIDProject:
		return e.GetClient().GetInnerObjectInst(e.GetKit(), common.BKInnerObjIDProject, cond)
	default:
