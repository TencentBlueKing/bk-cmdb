...
var ServiceInstanceAuthConfigs = []AuthConfig{
	{
		...
		ResourceType:   meta2.ProcessServiceInstance,
		...
		HTTPMethod:     http.MethodPost,
		BizIDGetter:    DefaultBizIDGetter,
		ResourceType:   meta2.HostInstance,
		ResourceAction: meta2.FindMany,
	}, {
		...
		ResourceAction: meta2.AccessBizSet,
	...
	},
	{
		...
		BizIndex:       6,
		ResourceType:   meta2.ProcessServiceInstance,
		ResourceAction: meta2.UpdateMany,
	}, {
		...
		BizIDGetter:    BizIDFromURLGetter,
		BizIndex:       6,
		ResourceType:   meta2.ProcessServiceTemplate,
		ResourceAction: meta2.Find,
	}, {
