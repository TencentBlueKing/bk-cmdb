...
func (ps *parseStream) getInstanceTypeByObject(objID string, ID int64) (meta2.ResourceType, error) {
	switch objID {
	case common.BKInnerObjIDPlat:
		return meta2.CloudAreaInstance, nil
	case common.BKInnerObjIDHost:
		return meta2.HostInstance, nil
	case common.BKInnerObjIDModule:
		return meta2.ModelModule, nil
	case common.BKInnerObjIDSet:
		return meta2.ModelSet, nil
	case common.BKInnerObjIDApp:
		return meta2.Business, nil
	case common.BKInnerObjIDProc:
		return meta2.Process, nil
	case common.BKInnerObjIDBizSet:
		return meta2.BizSet, nil
	}
	...
	if isMainline {
		return meta2.MainlineInstance, nil
	}
...
func (ps *parseStream) generateUpdateInstanceResource(model *metadata.Object, instID int64) (*meta2.ResourceAttribute,
	error) {
	...
	case meta2.HostInstance:
		...
		if bizID != rscPoolBizID {
			return &meta2.ResourceAttribute{
				Basic: meta2.Basic{
					Type:       instanceType,
					Action:     meta2.Update,
					InstanceID: instID,
				},
				Layers:     []meta2.Item{{Type: meta2.Business, InstanceID: bizID}},
				BusinessID: bizID,
			}, nil
		}
		...
		return &meta2.ResourceAttribute{
			...
			Layers: []meta2.Item{{Type: meta2.ResourcePoolDirectory, InstanceID: relationRes.Info[0].ModuleID}},
		}, nil
	case meta2.Business, meta2.BizSet, meta2.CloudAreaInstance:
		return &meta2.ResourceAttribute{
			Basic: meta2.Basic{
				Type:       instanceType,
				Action:     meta2.Update,
	...
	case meta2.ModelSet, meta2.ModelModule, meta2.MainlineInstance, meta2.Process:
