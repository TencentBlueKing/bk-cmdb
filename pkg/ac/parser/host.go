	...
	if ps.hitRegexp(saveModelDefaultCustomPattern, http.MethodPost) {
		...
		ps.Attribute.Resources = []meta2.ResourceAttribute{
			...
			},
			{
				BusinessID: bizID,
				Basic: meta2.Basic{
					Type:   meta2.ModelAttribute,
					Action: meta2.Create,
				},
				Layers: []meta2.Item{{Type: meta2.Model, InstanceID: model.ID}},
			},
		}
		return ps
...
func (ps *parseStream) host() *parseStream {
	...
	if ps.hitPattern(updateHostCloudAreaFieldPattern, http.MethodPut) {
		...
		ps.Attribute.Resources = make([]meta2.ResourceAttribute, 0)
		...
		ps.Attribute.Resources = []meta2.ResourceAttribute{
			{
				BusinessID: bizID,
				Basic: meta2.Basic{
					Type:   meta2.ProcessServiceInstance,
					Action: meta2.Update,
				},
			},
		}
		...
		ps.Attribute.Resources = []meta2.ResourceAttribute{
			{
				BusinessID: bizID,
				Basic: meta2.Basic{
					Type:   meta2.MainlineInstanceTopology,
					Action: meta2.Find,
				},
			},
		}
...
func (ps *parseStream) hostTransfer() *parseStream {
		...
		ps.Attribute.Resources = []meta2.ResourceAttribute{
			{
				Basic: meta2.Basic{
					Type:   meta2.HostInstance,
					Action: meta2.AddHostToResourcePool,
				},
				Layers: []meta2.Item{
					{
		...
		ps.Attribute.Resources = []meta2.ResourceAttribute{
			{
				...
				Basic: meta2.Basic{
					Type:   meta2.HostInstance,
					Action: meta2.MoveBizHostFromModuleToResPool,
				},
				Layers: []meta2.Item{
					{
						Type:       meta2.Business,
			...
			ps.Attribute.Resources = []meta2.ResourceAttribute{
				{
					...
					Basic: meta2.Basic{
						Type:       meta2.HostInstance,
						Action:     meta2.MoveResPoolHostToBizIdleModule,
						InstanceID: id,
					},
					Layers: []meta2.Item{{Type: meta2.ModelModule, InstanceID: srcModuleID},
						{Type: meta2.Business, InstanceID: opt.Business}},
				},
			}
		}
		...
		ps.Attribute.Resources = []meta2.ResourceAttribute{
			{
				...
				Basic: meta2.Basic{
					Type:   meta2.HostInstance,
					Action: meta2.MoveHostToAnotherBizModule,
				},
				Layers: []meta2.Item{
					{
						Type:       meta2.Business,
	...
	if ps.hitPattern(moveResourceHostAcrossBizPattern, http.MethodPost) {
		...
		for _, bizId := range bizIds {
			ps.Attribute.Resources = append(ps.Attribute.Resources, meta2.ResourceAttribute{
				BusinessID: bizId,
				Basic: meta2.Basic{
					Type:   meta2.HostInstance,
					Action: meta2.MoveHostToAnotherBizModule,
			...
			ps.Attribute.Resources = []meta2.ResourceAttribute{
				{
					Basic: meta2.Basic{
						Type:       meta2.HostInstance,
						Action:     meta2.MoveResPoolHostToDirectory,
						InstanceID: id,
					},
					Layers: []meta2.Item{{Type: meta2.ModelModule, InstanceID: srcModuleID},
						{Type: meta2.ModelModule, InstanceID: opt.ModuleID}},
				},
			}
		}
