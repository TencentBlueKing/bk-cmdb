...
func (am *AuthManager) MakeResourcesByModule(header http.Header, action meta2.Action, businessID int64, modules ...ModuleSimplify) []meta2.ResourceAttribute {
	resources := make([]meta2.ResourceAttribute, 0)
	for _, module := range modules {
		resource := meta2.ResourceAttribute{
			Basic: meta2.Basic{
				Action:     action,
				Type:       meta2.ModelModule,
...
func (am *AuthManager) AuthorizeByModuleID(ctx context.Context, header http.Header, action meta2.Action, ids ...int64) error {
	if !am.Enabled() {
		return nil
	}
...
func (am *AuthManager) AuthorizeByModule(ctx context.Context, header http.Header, action meta2.Action, modules ...ModuleSimplify) error {
	rid := util.ExtractRequestIDFromContext(ctx)
