...
// NewAuthManager TODO
func NewAuthManager(clientSet api.ClientSetInterface, iamCli *iamtype.IAM) *AuthManager {
	return &AuthManager{
		clientSet:                    clientSet,
		Authorizer:                   iamtype.NewAuthorizer(clientSet),
		Viewer:                       iamtype.NewViewer(clientSet, iamCli),
