...
func (am *AuthManager) MakeResourcesBySet(header http.Header, action meta2.Action, businessID int64, sets ...SetSimplify) []meta2.ResourceAttribute {
...
func (am *AuthManager) AuthorizeBySetID(ctx context.Context, header http.Header, action meta2.Action, ids ...int64) error {
	if !am.Enabled() {
		return nil
	}
...
// AuthorizeBySet TODO
func (am *AuthManager) AuthorizeBySet(ctx context.Context, header http.Header, action meta2.Action, sets ...SetSimplify) error {
	rid := util.ExtractRequestIDFromContext(ctx)
