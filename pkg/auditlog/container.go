...
func (c *kubeAuditLog) GenerateClusterAuditLog(param *generateAuditCommonParameter,
	data []types2.Cluster) ([]metadata.AuditLog, errors.CCErrorCoder) {
...
func (c *kubeAuditLog) GenerateNodeAuditLog(param *generateAuditCommonParameter, data []types2.Node) (
...
func (c *kubeAuditLog) GenerateNamespaceAuditLog(param *generateAuditCommonParameter, data []types2.Namespace) (
	[]metadata.AuditLog, errors.CCErrorCoder) {
...
func (c *kubeAuditLog) GeneratePodAuditLog(param *generateAuditCommonParameter, data []types2.Pod) (
	[]metadata.AuditLog, errors.CCErrorCoder) {
...
type kubeWorkloadData struct {
	Kind types2.WorkloadType `json:"kind" bson:"kind"`
	Data types2.WorkloadI    `json:"data" bson:"data"`
}

// GenerateWorkloadAuditLog generate audit log of kube workload.
func (c *kubeAuditLog) GenerateWorkloadAuditLog(param *generateAuditCommonParameter, data []types2.WorkloadI,
	kind types2.WorkloadType) ([]metadata.AuditLog, errors.CCErrorCoder) {
