...
{{- define "cmdb.redis.discover.host" -}}
  {{- if eq .Values.redis.enabled true -}}
    {{- template "cmdb.redis.fullname" . -}}:{{- printf "%s" "6379" -}}
  {{- else -}}
    {{- .Values.redis.discover_redis.host -}}
  {{- end -}}
{{- end -}}
...
{{- if .Values.redis.enabled -}}
     {{- .Values.redis.auth.password -}}
{{- else }}
     {{- .Values.redis.discover_redis.pwd -}}
{{- end -}}
{{- end -}}
...
{{- define "cmdb.redis.netcollect.host" -}}
  {{- if eq .Values.redis.enabled true -}}
    {{- template "cmdb.redis.fullname" . -}}:{{- printf "%s" "6379" -}}
  {{- else -}}
    {{- .Values.redis.netcollect_redis.host -}}
  {{- end -}}
{{- end -}}
...
{{- if .Values.redis.enabled -}}
     {{- .Values.redis.auth.password -}}
{{- else }}
     {{- .Values.redis.netcollect_redis.pwd -}}
{{- end -}}
{{- end -}}
...
{{- define "cmdb.webserver.bkLoginUrl" -}}
  {{- if eq .Values.common.login.version "opensource" -}}
    {{- printf "%s" "" -}}
  {{- else -}}
    {{- printf "%s" .Values.paas.url -}}/login/?app_id=%s&c_url=%s
  {{- end -}}
{{- end -}}
...
{{- define "cmdb.webserver.paas_domain_url" -}}
  {{- if eq .Values.common.login.version "opensource" -}}
    {{- printf "%s" "" -}}
  {{- else -}}
    {{- printf "%s" .Values.common.esb.addr -}}
  {{- end -}}
{{- end -}}