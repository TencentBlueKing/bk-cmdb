...
import (
	...
	"configcenter/test/run"
	testutil "configcenter/test/util"

	. "github.com/onsi/gomega"
)

var clientSet api.ClientSetInterface
...
func init() {
	...
	clientSet, err = api.NewApiMachinery(c, disc)
	Expect(err).Should(BeNil())
...
// GetClientSet TODO
func GetClientSet() api.ClientSetInterface {
	return clientSet
}
