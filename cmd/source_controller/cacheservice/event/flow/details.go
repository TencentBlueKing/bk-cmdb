...
type getDeleteEventDetailsFunc func(es []*types.Event, db dal.DB, metrics *event2.EventMetrics) (map[oidCollKey][]byte,
	bool, error)

// getDeleteEventDetails get delete events' oid+collection to related detail map from cmdb
func getDeleteEventDetails(es []*types.Event, db dal.DB, metrics *event2.EventMetrics) (map[oidCollKey][]byte, bool,
	error) {
...
// getDeleteEventDetails get delete events' oid+collection to related detail map from cmdb
func getHostDeleteEventDetails(es []*types.Event, db dal.DB, metrics *event2.EventMetrics) (map[oidCollKey][]byte, bool,
	error) {
