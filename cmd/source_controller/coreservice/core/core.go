...
type ContainerOperation interface {
	CreateCluster(kit *rest.Kit, bizID int64, option *types2.ClusterBaseFields) (*types2.Cluster, errors.CCErrorCoder)
	...
	SearchCluster(kit *rest.Kit, input *metadata.QueryCondition) (*types2.ResponseCluster, error)
	DeleteCluster(kit *rest.Kit, bizID int64, option *types2.DeleteClusterOption) (*metadata.DeletedCount,
		errors.CCErrorCoder)
	BatchDeleteNode(kit *rest.Kit, bizID int64, option *types2.BatchDeleteNodeOption) (
		*metadata.DeletedCount, errors.CCErrorCoder)
	BatchCreateNode(kit *rest.Kit, bizID int64, data []types2.OneNodeCreateOption) ([]*types2.Node, errors.CCErrorCoder)
	BatchCreatePod(kit *rest.Kit, bizID int64, data []types2.PodsInfo) ([]types2.Pod, errors.CCErrorCoder)
	SearchNode(kit *rest.Kit, input *metadata.QueryCondition) (*types2.SearchNodeRsp, error)
}
...
// ContainerOperation container related operations
