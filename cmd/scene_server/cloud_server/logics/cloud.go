...
import (
	"configcenter/cmd/scene_server/cloud_server/cloudvendor"
	ccom "configcenter/cmd/scene_server/cloud_server/common"
...
func (lgc *Logics) ListAuthorizedResources(kit *rest.Kit, typ meta2.ResourceType, act meta2.Action) (
	[]int64, bool, error) {
