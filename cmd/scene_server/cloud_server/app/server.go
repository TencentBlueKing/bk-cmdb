...
import (
	"configcenter/cmd/scene_server/cloud_server/app/options"
	cloudsync2 "configcenter/cmd/scene_server/cloud_server/cloudsync"
	"configcenter/cmd/scene_server/cloud_server/logics"
	svc "configcenter/cmd/scene_server/cloud_server/service"
	...
	"configcenter/pkg/cryptor"
	"configcenter/pkg/types"
	"configcenter/pkg/util"
	"configcenter/thirdparty/secrets"
)
...
func (c *CloudServer) setSyncPeriod() {
	cloudsync2.SyncPeriodMinutes = c.Config.SyncPeriodMinutes
	if cloudsync2.SyncPeriodMinutes < cloudsync2.SyncPeriodMinutesMin {
		cloudsync2.SyncPeriodMinutes = cloudsync2.SyncPeriodMinutesMin
	}
	blog.Infof("sync period is %d minutes", cloudsync2.SyncPeriodMinutes)
}
