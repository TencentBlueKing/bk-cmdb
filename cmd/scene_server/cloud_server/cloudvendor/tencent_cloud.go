...
func (c *tcClient) GetVpcs(region string, opt *common.VpcOpt) (*metadata.VpcsInfo, error) {
	credential := c.newCredential(c.secretID, c.secretKey)
...
func (c *tcClient) GetInstances(region string, opt *common.InstanceOpt) (*metadata.InstancesInfo, error) {
	credential := c.newCredential(c.secretID, c.secretKey)
...
func (c *tcClient) GetInstancesTotalCnt(region string, opt *common.InstanceOpt) (int64, error) {
	if opt == nil {
		opt = common.GetDefaultInstanceOpt()
	}
...
func (c *tcClient) newDescribeVpcsRequest(opt *common.VpcOpt) *tcVpc.DescribeVpcsRequest {
...
func (c *tcClient) newDescribeInstancesRequest(opt *common.InstanceOpt) *cvm.DescribeInstancesRequest {
...
func (c *tcClient) setVpcFilters(dst *[]*tcVpc.Filter, src []*common.Filter) {
...
func (c *tcClient) setCvmFilters(dst *[]*cvm.Filter, src []*common.Filter) {
	if src == nil || len(src) == 0 {
		return
	}
	if dst == nil {
