...
func (s *Service) CreateWorkload(ctx *rest.Contexts) {
	...
	var data *types2.WlCreateRespData
...
func (s *Service) listWorkload(kit *rest.Kit, query *metadata.QueryCondition, kind types2.WorkloadType) (
	[]types2.WorkloadI, error) {
