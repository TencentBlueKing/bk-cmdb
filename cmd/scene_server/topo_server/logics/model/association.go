...
type AssociationOperationInterface interface {
	...
	SetProxy(object ObjectOperationInterface, inst inst2.InstOperationInterface,
		instasst inst2.AssociationOperationInterface)
}

// NewAssociationOperation create a new association operation instance
func NewAssociationOperation(client api.ClientSetInterface,
...
// SetProxy proxy the interface
func (assoc *association) SetProxy(object ObjectOperationInterface, inst inst2.InstOperationInterface,
	instasst inst2.AssociationOperationInterface) {
