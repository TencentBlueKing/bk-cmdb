...
func addUncategorizedClassification(ctx context.Context, db dal.RDB, conf *upgrader2.Config) error {
	...
	if _, _, err := upgrader2.Upsert(ctx, db, table, &defaultClassificationRow, "id",
