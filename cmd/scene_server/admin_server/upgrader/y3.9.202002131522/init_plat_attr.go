...
func initPlatAttr(ctx context.Context, db dal.RDB, conf *upgrader2.Config) error {
	...
	for _, r := range dataRows {
		...
		if _, _, err := upgrader2.Upsert(ctx, db, common.BKTableNameObjAttDes, r, "id", uniqueFields, []string{}); err != nil {
