...
func addProcNetworkProxyGroup(ctx context.Context, db dal.RDB, conf *upgrader2.Config) error {
	...
	err := upgrader2.Insert(ctx, db, common.BKTableNamePropertyGroup, group, "id", uniqueFields)
	if err != nil {
...
func addProcNetworkProxyAttrs(ctx context.Context, db dal.RDB, conf *upgrader2.Config) error {
	...
	for _, r := range dataRows {
		...
		if err := upgrader2.Insert(ctx, db, common.BKTableNameObjAttDes, r, "id", uniqueFields); err != nil {
