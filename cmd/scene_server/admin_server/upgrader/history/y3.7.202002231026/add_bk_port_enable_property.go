...
func addProcEnablePortProperty(ctx context.Context, db dal.RDB, conf *upgrader2.Config) error {
	...
	if err := upgrader2.Insert(ctx, db, common.BKTableNameObjAttDes, addPortEnable, "id", uniqueFields); err != nil {
...
func addProcTemplatePortEnableProperty(ctx context.Context, db dal.RDB, conf *upgrader2.Config) error {
...
func setProcInfoProtEnableDefaultValue(ctx context.Context, db dal.RDB, conf *upgrader2.Config) error {
