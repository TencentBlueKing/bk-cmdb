...
func addBkStartParamRegex(ctx context.Context, db dal.RDB, conf *upgrader2.Config) (err error) {
...
func updateLanguageField(ctx context.Context, db dal.RDB, conf *upgrader2.Config) (err error) {
