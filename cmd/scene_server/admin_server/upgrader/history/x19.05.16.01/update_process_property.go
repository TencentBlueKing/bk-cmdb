...
import (
	mCommon "configcenter/cmd/scene_server/admin_server/common"
	upgrader2 "configcenter/cmd/scene_server/admin_server/upgrader"
...
func updateProcessBindIPProperty(ctx context.Context, db dal.RDB, conf *upgrader2.Config) error {
	...
	_, _, err := upgrader2.Upsert(ctx, db, common.BKTableNameObjAttDes, bindIPProperty, "id", uniqueFields, []string{})
	if nil != err {
...
func updateProcessNameProperty(ctx context.Context, db dal.RDB, conf *upgrader2.Config) error {
	type Attribute struct {
		ID                int64       `field:"id" json:"id" bson:"id"`
		OwnerID           string      `field:"bk_supplier_account" json:"bk_supplier_account" bson:"bk_supplier_account"`
		ObjectID          string      `field:"bk_obj_id" json:"bk_obj_id" bson:"bk_obj_id"`
	...
	uniqueFields := []string{common.BKObjIDField, common.BKPropertyIDField, common.BKOwnerIDField}
	_, _, err := upgrader2.Upsert(ctx, db, common.BKTableNameObjAttDes, ProcNameProperty, "id", uniqueFields, []string{})
	if nil != err {
...
func updateAutoTimeGapProperty(ctx context.Context, db dal.RDB, conf *upgrader2.Config) error {
	type Attribute struct {
		ID                int64       `field:"id" json:"id" bson:"id"`
		OwnerID           string      `field:"bk_supplier_account" json:"bk_supplier_account" bson:"bk_supplier_account"`
		ObjectID          string      `field:"bk_obj_id" json:"bk_obj_id" bson:"bk_obj_id"`
	...
	uniqueFields := []string{common.BKObjIDField, common.BKPropertyIDField, common.BKOwnerIDField}
	_, _, err := upgrader2.Upsert(ctx, db, common.BKTableNameObjAttDes, property, "id", uniqueFields, []string{})
	if nil != err {
...
func updateProcNumProperty(ctx context.Context, db dal.RDB, conf *upgrader2.Config) error {
	type Attribute struct {
		ID                int64       `field:"id" json:"id" bson:"id"`
		OwnerID           string      `field:"bk_supplier_account" json:"bk_supplier_account" bson:"bk_supplier_account"`
		ObjectID          string      `field:"bk_obj_id" json:"bk_obj_id" bson:"bk_obj_id"`
...
func updatePriorityProperty(ctx context.Context, db dal.RDB, conf *upgrader2.Config) error {
	type Attribute struct {
		ID                int64       `field:"id" json:"id" bson:"id"`
		OwnerID           string      `field:"bk_supplier_account" json:"bk_supplier_account" bson:"bk_supplier_account"`
		ObjectID          string      `field:"bk_obj_id" json:"bk_obj_id" bson:"bk_obj_id"`
...
func updateTimeoutProperty(ctx context.Context, db dal.RDB, conf *upgrader2.Config) error {
	type Attribute struct {
		ID                int64       `field:"id" json:"id" bson:"id"`
		OwnerID           string      `field:"bk_supplier_account" json:"bk_supplier_account" bson:"bk_supplier_account"`
		ObjectID          string      `field:"bk_obj_id" json:"bk_obj_id" bson:"bk_obj_id"`
...
func updateProcessNamePropertyIndex(ctx context.Context, db dal.RDB, conf *upgrader2.Config) error {
...
func updateFuncNamePropertyIndex(ctx context.Context, db dal.RDB, conf *upgrader2.Config) error {
...
func deleteProcessUnique(ctx context.Context, db dal.RDB, conf *upgrader2.Config) error {
...
func updateFuncIDProperty(ctx context.Context, db dal.RDB, conf *upgrader2.Config) error {
	type Attribute struct {
		ID                int64       `field:"id" json:"id" bson:"id"`
		OwnerID           string      `field:"bk_supplier_account" json:"bk_supplier_account" bson:"bk_supplier_account"`
		ObjectID          string      `field:"bk_obj_id" json:"bk_obj_id" bson:"bk_obj_id"`
...
func UpdateProcPortPropertyGroupName(ctx context.Context, db dal.RDB, conf *upgrader2.Config) error {
	...
	if _, _, err := upgrader2.Upsert(ctx, db, common.BKTableNamePropertyGroup, row, "id", []string{common.BKObjIDField, "bk_group_id"}, []string{"id"}); err != nil {
