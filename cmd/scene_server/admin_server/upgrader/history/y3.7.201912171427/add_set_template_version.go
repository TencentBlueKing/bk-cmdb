...
func addSetTemplateDefaultVersion(ctx context.Context, db dal.RDB, conf *upgrader2.Config) error {
...
func addSetDefaultVersion(ctx context.Context, db dal.RDB, conf *upgrader2.Config) error {
	filter := map[string]interface{}{
...
func addSetVersionField(ctx context.Context, db dal.RDB, conf *upgrader2.Config) error {
	filter := map[string]interface{}{
	...
	if _, _, err := upgrader2.Upsert(ctx, db, common.BKTableNameObjAttDes, attribute, "id", uniqueFields, []string{}); err != nil {
