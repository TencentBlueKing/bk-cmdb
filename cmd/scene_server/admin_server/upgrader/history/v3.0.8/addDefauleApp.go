...
func addDefaultBiz(ctx context.Context, db dal.RDB, conf *upgrader2.Config) error {
	...
	bizID, _, err := upgrader2.Upsert(ctx, db, common.BKTableNameBaseApp, defaultBiz, common.BKAppIDField, []string{common.BKOwnerIDField, common.BKAppNameField, common.BKDefaultField}, append(filled, common.BKAppIDField))
	if err != nil {
	...
	setID, _, err := upgrader2.Upsert(ctx, db, common.BKTableNameBaseSet, defaultSet, common.BKSetIDField, []string{common.BKOwnerIDField, common.BKSetNameField, common.BKAppIDField, common.BKDefaultField}, append(filled, common.BKSetIDField))
	if err != nil {
	...
	_, _, err = upgrader2.Upsert(ctx, db, common.BKTableNameBaseModule, defaultResModule, common.BKModuleIDField, []string{common.BKOwnerIDField, common.BKModuleNameField, common.BKAppIDField, common.BKSetIDField, common.BKDefaultField}, append(filled, common.BKModuleIDField))
	if err != nil {
	...
	_, _, err = upgrader2.Upsert(ctx, db, common.BKTableNameBaseModule, defaultFaultModule, common.BKModuleIDField, []string{common.BKOwnerIDField, common.BKModuleNameField, common.BKAppIDField, common.BKSetIDField, common.BKDefaultField}, append(filled, common.BKModuleIDField))
	if err != nil {
