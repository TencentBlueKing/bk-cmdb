...
func addPlatData(ctx context.Context, db dal.RDB, conf *upgrader2.Config) error {
	...
	_, _, err = upgrader2.Upsert(ctx, db, tableName, row, "", []string{common.BKCloudNameField, common.BKOwnerIDField}, []string{common.BKCloudIDField})
	if nil != err {
