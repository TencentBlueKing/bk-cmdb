...
import (
	com "configcenter/cmd/scene_server/admin_server/common"
...
func addHostFieldTypeList(ctx context.Context, db dal.RDB, conf *upgrader2.Config) error {
	optionVal := []string{
		"运营中[需告警]",
		"运营中[无告警]",
		"开发中[需告警]",
	...
	if err := upgrader2.Insert(ctx, db, common.BKTableNameObjAttDes, hostListTypeField, "id", uniqueFields); err != nil {
