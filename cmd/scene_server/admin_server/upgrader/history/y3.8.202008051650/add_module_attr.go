...
func addModuleAttr(ctx context.Context, db dal.RDB, conf *upgrader2.Config) error {
	...
	if err := upgrader2.Insert(ctx, db, common.BKTableNameObjAttDes, row, "id", uniqueFields); err != nil {
