...
func AddProcAttrGroup(ctx context.Context, db dal.RDB, conf *upgrader2.Config) error {
	...
	_, _, err := upgrader2.Upsert(ctx, db, common.BKTableNamePropertyGroup, doc, "id", uniqueFields, []string{})
	if err != nil {
...
func ChangeProcFieldGroup(ctx context.Context, db dal.RDB, conf *upgrader2.Config) error {
