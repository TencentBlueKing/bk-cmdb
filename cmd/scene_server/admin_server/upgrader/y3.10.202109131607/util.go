...
func parseInstancePolicy(policy *operator2.Policy) (*parsedInstancePolicy, error) {
...
func parseCombinedInstancePolicy(policy *operator2.Policy) (*parsedInstancePolicy, error) {
	content, ok := policy.Element.(*operator2.Content)
	if !ok {
	...
	if policy.Operator == operator2.And {
...
func parseAutomaticInstancePolicy(policy *operator2.Policy) (*parsedInstancePolicy, error) {
	fieldValue, ok := policy.Element.(*operator2.FieldValue)
	if !ok {
