...
import (
	"configcenter/cmd/scene_server/admin_server/app/options"
	"configcenter/cmd/scene_server/admin_server/configures"
	"configcenter/cmd/scene_server/admin_server/iam"
	"configcenter/cmd/scene_server/admin_server/logics"
	svc "configcenter/cmd/scene_server/admin_server/service"
	...
	"configcenter/thirdparty/monitor"
)
...
func Run(ctx context.Context, cancel context.CancelFunc, op *options.ServerOption) error {
	...
	process.Config.IAM, err = iamtype.ParseConfigFromKV("authServer", nil)
	...
	for {
		...
		if auth.EnableAuthorize() {
			...
			iamCli, err = iamtype.NewIAM(process.Config.IAM, engine.Metric().Registry())
			if err != nil {
