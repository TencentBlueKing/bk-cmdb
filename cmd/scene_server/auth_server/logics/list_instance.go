...
func (lgc *Logics) listInstance(kit *rest.Kit, cond map[string]interface{}, resourceType iamtype.TypeID, page types.Page) (
...
func (lgc *Logics) searchAuthResource(kit *rest.Kit, param metadata.PullResourceParam, resourceType iamtype.TypeID) (
...
func (lgc *Logics) ListSystemInstance(kit *rest.Kit, resourceType iamtype.TypeID, filter *types.ListInstanceFilter,
...
func (lgc *Logics) ListBusinessInstance(kit *rest.Kit, resourceType iamtype.TypeID, filter *types.ListInstanceFilter,
	...
	if filter.Parent.Type != iamtype.Business {
...
func (lgc *Logics) ListModelInstance(kit *rest.Kit, resourceType iamtype.TypeID, filter *types.ListInstanceFilter,
	page types.Page) (*types.ListInstanceResult, error) {
	...
	if filter.Parent.Type != iamtype.SysInstanceModel {
		return &types.ListInstanceResult{Count: 0, Results: []types.InstanceResource{}}, nil
	}
...
func (lgc *Logics) ListHostInstance(kit *rest.Kit, resourceType iamtype.TypeID, filter *types.ListInstanceFilter,
	page types.Page) (*types.ListInstanceResult, error) {
	...
	if filter.Parent.Type != iamtype.SysHostRscPoolDirectory && filter.Parent.Type != iamtype.Business /* iam.Module */ {
		return &types.ListInstanceResult{Count: 0, Results: []types.InstanceResource{}}, nil
	}
