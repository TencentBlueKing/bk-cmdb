...
import (
	"configcenter/cmd/scene_server/proc_server/app/options"
	"configcenter/cmd/scene_server/proc_server/logics"
	"configcenter/cmd/scene_server/proc_server/service"
...
func Run(ctx context.Context, cancel context.CancelFunc, op *options.ServerOption) error {
	...
	procSvr.Config.Auth, err = iamtype.ParseConfigFromKV("authServer", nil)
	if err != nil {
	...
	if auth.EnableAuthorize() {
		...
		iamCli, err = iamtype.NewIAM(procSvr.Config.Auth, engine.Metric().Registry())
		if err != nil {
