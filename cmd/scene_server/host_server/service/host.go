...
import (
	"configcenter/cmd/scene_server/host_server/logics"
	hutil "configcenter/cmd/scene_server/host_server/util"
	"configcenter/pkg/ac"
	"configcenter/pkg/ac/extensions"
	authmeta "configcenter/pkg/ac/meta"
	...
	meta "configcenter/pkg/metadata"
	hostParse "configcenter/pkg/paraparse"
...
func (s *Service) getHostIDsByKubeCond(kit *rest.Kit, req types2.SearchHostReq) ([]int64, error) {
...
func (s *Service) getHostByKubeTopoFilter(kit *rest.Kit, req types2.SearchHostReq) ([]int64, error) {
	...
	if req.ClusterID != 0 {
		cond[types2.BKClusterIDFiled] = req.ClusterID
	}

	if req.NamespaceID != 0 {
		cond[types2.BKNamespaceIDField] = req.NamespaceID
	}

	if req.WorkloadID != 0 && req.WlKind != "" {
		cond[types2.RefIDField] = req.WorkloadID
		cond[types2.RefKindField] = req.WlKind
	}
...
func (s *Service) getHostInFolder(kit *rest.Kit, bizID int64, clusterID int64) ([]int64, error) {
	...
	if clusterID == 0 {
		return nil, kit.CCError.Errorf(common.CCErrCommParamsIsInvalid, types2.BKClusterIDFiled)
	}
...
func (s *Service) getHostByClusterOrNode(kit *rest.Kit, req types2.SearchHostReq, hasHostIDCond bool, hostIDs []int64) (
	[]int64, error) {
	var err error
	cond := mapstr.MapStr{}
...
func (s *Service) buildResult(kit *rest.Kit, hosts []mapstr.MapStr, req types2.SearchHostReq) ([]mapstr.MapStr, error) {
	...
	hostIDToNode := make(map[int64][]types2.Node)
...
func (s *Service) findNodeByHostIDs(kit *rest.Kit, hostIDs []int64, fields []string) (map[int64][]types2.Node, error) {
