...
| name                | String     | 命名空间名称                     |
| labels              | Object     | 标签                         |
| resource_quotas     | Object     | 命名空间CPU与内存的requests与limits |
| bk_supplier_account | String     | 开发商ID，默认0                  |
| create_time         | ISODate    | 创建时间                       |
| last_time           | ISODate    | 最后更新时间                     |
...
|---------------------|------------|-------------------|
| _id                 | ObjectId   | 数据唯一ID            |
| bk_biz_id           | NumberLong | vcluster所在的业务ID   |
| bk_cluster_id       | NumberLong | 集群在cc表中的唯一标识      |
| bk_namespace_id     | NumberLong | 宿主集群的namespace ID |
| bk_asst_biz_id      | NumberLong | vcluster关联的业务     |
| bk_supplier_account | String     | 开发商ID，默认0         |
| create_time         | ISODate    | 创建时间              |
| last_time           | ISODate    | 最后更新时间            |
