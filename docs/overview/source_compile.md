...
![image](../resource/img/ui_err1.png)

![image](../resource/img/ui_err2.png)

**解决办法：安装 nvm 工具，通过 nvm 工具安装 nodejs**
...
![image](../resource/img/node_result.png)

5. 再次进入项目src目录执行`make ui`进行编译，编译成功查看相应输出目录

![image](../resource/img/ui_build_success.png)
