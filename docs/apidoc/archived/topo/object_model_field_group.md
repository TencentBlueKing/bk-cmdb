### 创建分组基本信息
- API: POST /api/v3/create/objectattgroup
- API 名称：create_group
- 功能说明: 
	- 中文: 创建分组
...
### 查询分组基本信息
- API: POST /api/v3/find/objectattgroup/object/{bk_obj_id}
- API 名称：search_group
- 功能说明：
	- 中文：查询分组信息
...
### 修改分组基本信息
- API: PUT  /api/v3/update/objectattgroup
- API 名称：update_group
- input body
...
### 删除分组基本信息
- API: DELETE /api/v3/delete/objectattgroup/{id}
- API 名称：delete_group
- 功能说明：
	- 中文：删除模型分组
...
### 删除模型属性分组关联
- API: DELETE  /api/v3/delete/objectattgroupasst/object/{bk_obj_id}/property/{bk_property_id}/group/{bk_group_id}
- API 名称：delete_object_property_group
- 功能说明：
	- 中文：从模型属性分组中删除属性
	- English：delete property from the group of the object 
