## [Version: v3.14.9-alpha2] - 2026-08-05
**缺陷修复**
- CPU架构下拉选择时，提示信息遮挡了字段问题修复

## [Version: v3.14.9-alpha1] - 2026-07-28
**新增功能**
- 支持前端隐藏模型属性
...
- 优化字段组合模板引用模型的内置字段报错的错误信息

**缺陷修复**
- 业务拓扑中自定义字段bool字段默认值无效
- 集群与服务模板“组织”字段编辑交互问题修复
- 主机全部列表翻页后切换已分配未分配无数据问题修复
- 模型表格字段默认值操作按钮被遮挡问题修复
- IPv6主机操作审计详情实例没有显示问题修复
