## [Version: v3.10.24-feature-table-beta2] - 2023-04-27
**缺陷修复**
- 修复验收会体验问题

## [Version: v3.10.24-feature-table-alpha6] - 2023-04-27
**功能优化**
- 优化了一些前端的显示问题
- 表格默认值不校验字段是否必填

**缺陷修复**
- 修复新建表格字段时，切换字段类型仍保留上次配置的默认值问题
- 修复表格数量小于5时，还是会报表格字段数量限制的问题
...
## [Version: v3.10.24-feature-table-alpha4] - 2023-04-23
- 修复可成功导入超出字段范围的值的问题
- 修复某些场景下无法新建实例的问题

## [Version: v3.10.24-feature-table-alpha3] - 2023-04-23
**缺陷修复**
- 无法编辑表格字段
- 编辑时存在线条且存在无法查看到浮点完整值等情况
- 无法编辑删除表格字段（置灰加锁）
- 存在无法提交表格字段的情况
- 当进入实例详情编辑表格字段时，存在异常报错
- 可成功导入超出字段范围的值
...
## [Version: v3.10.24-feature-table-alpha1] - 2023-04-15
**新增功能**
- 新增支持表格字段功能

## [Version: v3.10.24-beta1] - 2023-04-19
**功能优化**
- 优化了一些前端的显示问题
...
- 修复属性结构中的必填字段tag错误的问题

## [Version: v3.10.24-alpha3] - 2023-04-17
**功能优化**
- 优化了一些前端的显示问题

**缺陷修复**
- 修复创建实例时，在默认值为数据类型场景下没有传默认值字段会报错的问题
- 修复了字段类型切换后，默认值显示异常的问题
- 修复了列表字段选择默认值后，显示空白值的问题

## [Version: v3.10.24-alpha2] - 2023-04-11
**功能优化**
- 去掉cmdb中枚举引用类型的相关功能

**缺陷修复**
- 修复模型属性默认值excel导入导出失败的问题
