## [Version: v3.11.1-alpha3] - 2023-08-04
**缺陷修复**
- 修复动态分组二次确认弹窗错误
- 创建实例时表格字段，数字类型设置默认值后，不能编辑
- 新增主机到模块，添加已选择的主机，点击主机后方的删除icon图标后会返回业务拓扑页面

## [Version: v3.11.1-alpha2] - 2023-08-03
**功能优化**
- 优化了一些前端的显示问题
...
- 修复导出模型文件加密选项未生效的问题
- 绑定的模型下输入“\ ?”字符会报查询数据失败的错误
- 自定义字段下编辑集群/模块/主机下的字段信息后会报错，但实际字段信息上已经修改成功

## [Version: v3.11.1-alpha1] - 2023-07-31
**新增功能**
- 支持登录应用访问限制功能
- 新增字段组合模版功能
- 新增支持ipv6特性功能
