## [Version: v3.10.51] - 2025-02-19
**缺陷修复**
- 修复导出模型时的目录穿越问题
- 修复下发主机身份文件逻辑死循环问题
- 修复excel导入主机、实例时association子表不存在导致导入后点击下一步出现空白页面的问题
- 修复list_hosts_without_biz接口的排序功能失效问题

## [Version: v3.10.50] - 2024-08-27
**缺陷修复**
- 修复主机操作审计按id搜索输入非数字，能查询全部数据的问题
- 修复操作审计模型分组、模型展示动作有误问题
- 修复实例列表页，点击实例ID链接无跳转问题

## [Version: v3.10.49] - 2024-08-02
**缺陷修复**
- 修复模型实例关联拓扑图箭头指向问题
- 修改资源目录中业务条目显示的数量为“未归档的业务数”
- 组件安全漏洞修复

## [Version: v3.10.48] - 2024-07-16
**缺陷修复**
- 组件安全漏洞修复
- 修复自动发现cpu架构字段失败的问题(采集器版本：bkmonitorbeat >= v3.28.1542, basereport = 10.12.85)

## [Version: v3.10.47] - 2024-07-11
**功能优化**
- 升级go版本到1.20并调整go mod依赖

## [Version: v3.10.46] - 2024-04-18
**缺陷修复**
- 修复权限中心查询实例时输入正则表达式中的部分特殊字符时报错问题
- 修复导入文件时未校验文件格式导致可上传不合法的文件问题

## [Version: v3.10.45] - 2024-03-12
**缺陷修复**
- 修复当未启用鉴权时，依然频繁扫描zk中的auth节点导致记录大量日志的问题
- 修复在QueryFilter中设置时间条件不生效问题

## [Version: v3.10.44] - 2024-02-01
**缺陷修复**
- 修复在获取用户数据时并发读写Header导致webserver服务panic的问题

## [Version: v3.10.43] - 2024-01-17
**缺陷修复**
- 修复服务模版中删除进程后，弹框不消失的问题
- 修复模型导入属性字段顺序错乱的问题

## [Version: v3.10.42] - 2023-09-20
**缺陷修复**
...
- 修复无进程模板场景下同步状态不准确问题
- 修复小窗登录地址
- 解决主机自动应用，按服务模板配置如果这个业务没有模板会有报错的问题
- 解决添加主机时显示的进程信息和添加后查看主机的进程信息不一致的问题
- 修复了其他一些已知问题
