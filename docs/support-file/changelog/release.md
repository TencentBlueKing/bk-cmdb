## [Version: v3.14.7-alpha4] - 2026-04-07
**功能优化**
- 添加日志状态码
- 升级版本依赖
- 优化文档链接更新
...
**缺陷修复**
- 修复前端业务集主机批量复制"管控区域ID:IP"，复制出无效信息问题
- 修复前端主机操作系统类型统计指标中，图例取值错误及动态分组搜索分隔符优化
- 修复前端模型默认停用后仍在收藏导航栏显示问题及业务拓扑-新增主机到模块-搜索框-模型count不全问题
- 修复服务实例添加主机时使用IPv6搜索报错问题
- 修复业务拓扑中自定义字段bool字段默认值无效问题
- 修复主机自动应用查询问题
- 修复启停模型操作审计日志显示操作类型错误问题
- 修复运行统计实例统计时统计数据错误问题
- 修复前端表单创建重复提交问题
- 修复前端编辑直接新建的集群/模块下的自定义字段会显示是通过模板创建的，点击跳转对应模板会报错问题
- 修复前端导出提示问题
- 修复前端字段模版同步唯一校验没有获取最新数据问题
- 修复前端编辑主机自动应用时取消已选择的属性字段，"下一步"按钮变成置灰了不能点击问题
- 修复前端pod详情下点击所属拓扑报错问题
- 修复导出xlsx表格DDE问题
