## [Version: v3.10.29-feature-field-template-alpha6] - 2023-07-15
**缺陷修复**
- 修复字段组合模板申请模型编辑权限通过后，点击提交模型仍然提示需要申请权限
- 修复编辑字段组合模版时，点击「保存&下一步」出现申请字段组合模版创建权限问题

## [Version: v3.10.29-feature-field-template-beta2] - 2023-07-14
**功能优化**
- 优化了一些前端的显示问题
- 添加绑定解绑字段组合模版接口鉴权
- 字段组合模版唯一校验禁止添加枚举多选类型

**缺陷修复**
- 修复集群模版实例展示列表总数错误的问题
- 修复点击字段组合模版详情绑定的模型报错
- 修复添加字段唯一标识为bk开头后，点击下一步报错
- 修复字段组合模版从模型导入勾选字段点击确定后不生效
- 修复字段模版更新并创建唯一校验时报错问题
- 修复字段组合模版解绑时没有解除唯一校验绑定的问题
- 修复字段组合模版两个属性id和name一样时对比报错问题
- 修复了一些前端体验问题

**版本调整**
- 因为其他版本优先，字段组合模版功能包含在3.10.29版本

## [Version: v3.10.27-feature-field-template-beta1] - 2023-07-04
**缺陷修复**
- 修复字段组合模板唯一校验对比展示及编辑模板草稿问题

## [Version: v3.10.27-feature-field-template-alpha2] - 2023-07-03
**新增功能**
- 字段组合模板详情页中的克隆和删除操作
...
**缺陷修复**
- 修复字段组合模版一些问题
- 解决webserver查询模型的路由问题
- 解决创建字段组合模版的panic问题
- 修复字段组合模版对比问题
- 修复不传模版id可以更新唯一校验的问题
- 修复用模型查询字段模板时，模型没有关联的模板时返回了全部模板的问题
- 修复模型唯一校验属于其他字段模板时对比显示有冲突的问题
- 修复创建动态分组场景下点击提交按钮弹出二次确认框的问题

## [Version: v3.10.27-feature-field-template-alpha1] - 2023-06-25
**新增功能**
- 新增字段组合模版功能

## [Version: v3.10.28-beta1] - 2023-07-07
**功能优化**
- 优化了一些前端的显示问题

**缺陷修复**
- 修复表格数字类型字段没传时，值不为空的问题
- 修复没有成功设置中英文到用户管理的问题
- 修复主机高级筛选功能，云区域下拉框最大只拉取1000条数据的问题

## [Version: v3.10.27] - 2023-06-26
**功能优化**
- 优化了表格字段的索引设置
- 优化了api gateway的配置获取
- 优化了一些国际化相关问题
- 新增bkDomain配置，优化前端切换语言模式
- 云区域专有名词优化
- 调整调用gse的thrift接口证书
- 优化了一些前端的显示及规范类问题
...
- 修复枚举类型字段配置和保存时概率性报错问题
- 修复通过excel表格导出实例数量超过200条失败的问题
- 修复excel导入数据前端显示成功实际数据未导入成功的问题

## [Version: v3.10.25] - 2023-04-28
**新增功能**
- 新增支持表格字段功能
...
**新增功能**
- 新增模型属性字段支持添加默认值的功能
- 新增云主机接口支持根据云供应商+云主机ID判断主机是否需要更新
