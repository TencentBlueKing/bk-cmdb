## [Version: v3.13.6-alpha6] - 2024-04-30
**缺陷修复**
- 修复动态分组管理页面中折叠交互导致内容空白的问题（暂时取消折叠功能）

## [Version: v3.13.6-alpha5] - 2024-04-29
**缺陷修复**
- 修复动态分组设置条件时出现遮挡的问题及文案和样式优化
- 修复主机IP搜索刷新页面后变模糊搜索的问题

## [Version: v3.13.6-alpha4] - 2024-04-24
**缺陷修复**
- 前端问题修复

## [Version: v3.13.6-alpha3] - 2024-04-23
**新增功能**
- 用户快速选择器增加人员不存在提示
...
- 主机内网IP更改为"内网ipv4"
- 主机外网IP更改为"外网ipv4"
- execute_dynamic_group接口传入不在分组中的条件时进行报错
- 动态分组接口文档模糊匹配操作符为$regex
- 通过接口下发hostid，超过文件大小限制返回错误

**缺陷修复**
- 修复动态分组参数条件是范围相关类型时报错问题
- 动态分组“集群”预览有时间/日期字段接口报错
- 修正小窗登录地址
- hover字段查看更多信息时，临界位置易抖动
- 项目/业务下勾选第一个实例后，当前页最后一个实例也一起勾选了
- 导入模型拖拽文件没有校验
- 动态分组查询对象切换弹出二次确认
- 动态分组字段变化后条件自动展开

## [Version: v3.13.6-alpha2] - 2024-04-18
**缺陷修复**
- 动态分组无法编辑/保存

## [Version: v3.13.6-alpha1] - 2024-04-18
**新增功能**
- 新增“未分配”管控区域
- 动态分组能力增强-新增“可变条件”能力
- 新增校验登录态接口is_login
