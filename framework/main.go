...
import (
	...
	"configcenter/framework/api"
	"configcenter/framework/core/config"
	"configcenter/framework/core/discovery"
	"configcenter/framework/core/httpserver"
	"configcenter/framework/core/log"
	"configcenter/framework/core/monitor/metric"
	"configcenter/framework/core/option"
	"configcenter/framework/core/output/module/client"
	_ "configcenter/framework/plugins"
